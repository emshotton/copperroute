...
fn dsn_file_settings_reads_every_fixture_without_panicking() {
    ...
    for path in &files {
        ...
        let (block_layers, metadata_layers) = match copper_dsn::read_metadata(&bytes[..]) {
            BoardReadResult::Success {
                ...
                metadata
                    .router_settings
                    .as_ref()
                    .map_or(0, copper_dsn::parser::DsnRouterSettings::get_layer_count),
...
fn rules_file_settings_reads_every_fixture_without_panicking() {
    ...
    for path in &files {
        ...
        let expected = match copper_dsn::rules_reader::read_router_settings(&bytes[..]) {
