# `copper-settings` JVM probes (Plan 4)

JUnit-free Java drivers whose output is the source of every expected value in
`crates/copper-settings/tests/{field_path,router_settings,board_optimizations,sources,env_source,cli_source,json}.rs`
...
/opt/homebrew/opt/openjdk@25/bin/java -XX:ActiveProcessorCount=4 -Djava.awt.headless=true \
    ...
    /Users/em/Development/freerouting/freerouting-rs/crates/copper-settings/tests/data
