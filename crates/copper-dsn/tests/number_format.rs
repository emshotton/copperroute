...
use copper_dsn::{DsnScanner, Token};
...
fn float_to_string_is_not_the_widened_double() {
    ...
    assert_eq!(
        format_float(f32::MAX),
        "340282350000000000000000000000000000000"
    );
    assert_eq!(
        format_float(f32::from_bits(1)),
