...
use copper_board::PadstackId;
use copper_dsn::keyword::{Keyword, ScopeKeyword};
use copper_dsn::lexer::{DsnScanner, Token};
use copper_dsn::parser::library::write_padstack_scope;
use copper_dsn::parser::part_library::write_part_library_scope;
...
fn write_with(text: &str, write: impl FnOnce(&mut WriteScopeParameter<'_>)) -> String {
    read_pcb(text, |ok, p| {
        ...
        let mut buf: Vec<u8> = Vec::new();
        {
            ...
            let file = copper_dsn::format::IndentFileWriter::new(sink);
