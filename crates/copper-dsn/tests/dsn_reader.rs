...
use copper_dsn::{read_board, read_metadata};
...
fn success(result: &BoardReadResult) -> (&copper_board::Board, &[String]) {
    match result {
...
#[test]
fn read_board_merges_kicad_default_into_router_default() {
