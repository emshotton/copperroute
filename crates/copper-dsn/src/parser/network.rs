...
use copper_geometry::{Area, Point, ShapeOps, Vector};
...
fn insert_component(
    ...
    for i in 0..pin_count {
        ...
        let board_net_class = net_number_array
            ...
            .map(copper_board::Net::get_net_class);
...
pub fn write_via_infos<W: Write>(
    rules: &BoardRules,
    padstacks: &copper_board::Padstacks,
    file: &mut IndentFileWriter<W>,
    identifier_type: &IdentifierType,
) {
...
mod component_rejection_tests {
    use copper_board::{PackagePin, Packages, PadstackId};
    use copper_geometry::{IntVector, Vector};
    ...
    struct Outcome {
        ...
        pin_ids: Vec<copper_board::ItemId>,
        warnings: Vec<String>,
    }
