//! conversion.
use copper_geometry::{Circle, FloatPoint, IntBox, Line, Shape, ShapeOps, TileShape, Vector};
...
mod tests {
    ...
    fn board_to_dsn_vector_ignores_the_base_offsets() {
        ...
        let vector = Vector::Int(copper_geometry::IntVector::new(100, 200));
