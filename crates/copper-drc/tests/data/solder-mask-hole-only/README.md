...
A non-plated circular pad is completely removed by its equal-diameter circular drill. KiCad reports zero mask bridges. Both use a 1 mm pad, 1 mm drill, 0.2 mm front mask expansion and two foreign front tracks, plus one back track. Derived from solder-mask-unnetted.
