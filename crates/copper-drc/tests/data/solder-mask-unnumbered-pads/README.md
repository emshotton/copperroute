...
Both physical pads have empty pad numbers in the same footprint; they are not one logical pad. Both are unnetted. KiCad 10.0.6 reports 1 mask bridges. Derived from solder-mask-pad-pad with net assignments removed and pad numbers changed.
