...
Derived from `solder-mask-pad-track` by removing the two N2 track assignments. The pad net is also removed. KiCad 10.0.6 reports 2 front mask bridge(s), zero copper-clearance findings, and no back mask bridge.
