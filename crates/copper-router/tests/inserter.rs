...
use copper_router::autoroute::maze::AutorouteControl;
use copper_router::autoroute::maze::engine::AutorouteEngine;
use copper_router::autoroute::maze::search::MazeSearchEngine;
use copper_router::autoroute::path::{FoundConnectionInserter, FoundConnectionLocator};
...
///
/// ```text
/// cargo test -p copper-router --test inserter -- --ignored --nocapture emit_the_diag_port_golden
/// ```
#[test]
...
///
/// ```text
/// cargo test -p copper-router --test inserter -- --ignored --nocapture emit_the_around_port_golden
/// ```
#[test]
#[ignore = "generator: prints the port-lane golden for re-cutting"]
...
/// `P6T15Probe.ln`.
fn t15_line(line: &copper_geometry::Line) -> String {
