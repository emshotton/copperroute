...
use copper_board::ids::{ItemId, RoomId, TreeId, TreeObject};
use copper_board::prelude::*;
use copper_geometry::{
    Area, IntBox, IntOctagon, IntPoint, IntVector, Point, Polyline, Shape, TileShape, Vector,
};
use copper_router::autoroute::expansion::{ExpansionRoomStore, IncompleteFreeSpaceExpansionRoom};
...
fn route_ninety_degree_fixture() -> String {
    ...
    let mut ses = Vec::new();
    copper_dsn::ses_writer::write(&board, &transform, &mut ses, NINETY_DEGREE_STEM)
