...
use copper_geometry::{Area, IntBox, IntOctagon, IntVector, Point, Polyline, Shape, TileShape};
use copper_router::autoroute::expansion::sorted_neighbours::SortedRoomNeighbours;
...
fn dump_incomplete_rooms(rooms: &ExpansionRoomStore, skip: &[u32], out: &mut Vec<String>) {
    ...
    for (i, index) in engine_rooms.iter().enumerate() {
        let current = rooms
            .incomplete_room(copper_router::IncompleteRoomId(*index))
            .expect("a live room");
        out.push(format!(
...
fn assert_script(actual: &[String], expected: &str) {
    if std::env::var_os("COPPERROUTE_DUMP_SCRIPT").is_some() {
        for line in actual {
            eprintln!("DUMP|{line}");
        }
    }
...
fn the_45_degree_sorter_matches_the_p6t3_script() {
    ...
    assert_script(
        ...
        r#"
  neighbours n=3
    [0] fts=0 lts=2 obj=item6 nshape=Oct[-3600,-100,-1900,2100,-5641,-1859,-3641,141] nshapeCorners=(-3541,-100;-1959,-100;-1900,-41;-1900,2041;-1959,2100;-3541,2100;-3600,2041;-3600,-41) isect=Oct[-3541,2100,-3100,2100,-5641,-5200,-1441,-1000] isectCorners=(-3541,2100;-3100,2100;-3100,2100;-3100,2100;-3100,2100;-3541,2100;-3541,2100;-3541,2100)
    [1] fts=2 lts=4 obj=item12 nshape=Oct[-3100,6400,-1900,8600,-11641,-8359,3359,6641] nshapeCorners=(-3041,6400;-1959,6400;-1900,6459;-1900,8541;-1959,8600;-3041,8600;-3100,8541;-3100,6459) isect=Oct[-3100,6459,-3100,8222,-11322,-9559,3359,5122] isectCorners=(-3100,6459;-3100,6459;-3100,6459;-3100,8222;-3100,8222;-3100,8222;-3100,8222;-3100,6459)
    [2] fts=4 lts=4 obj=cfsr3 nshape=Oct[-5674,8222,-3634,10595,-16269,-11856,2548,6961] nshapeCorners=(-5674,8222;-3634,8222;-3634,8222;-3634,10595;-3634,10595;-5674,10595;-5674,10595;-5674,8222) isect=Oct[-5674,8222,-3634,8222,-13896,-11856,2548,4588] isectCorners=(-5674,8222;-3634,8222;-3634,8222;-3634,8222;-3634,8222;-5674,8222;-5674,8222;-5674,8222)
  edgeTouches=[true,true,true,true,true,false,false,false]
  completedRoom=cfsr11
  doors n=1
    [0] first=cfsr11 second=cfsr3 dim=1 shape=Oct[-5674,8222,-3634,8222,-13896,-11856,2548,4588] corners=(-5674,8222;-3634,8222;-3634,8222;-3634,8222;-3634,8222;-5674,8222;-5674,8222;-5674,8222)
  targetDoors n=0
"#,
    );
}
...
fn the_orthogonal_sorter_matches_the_p6t3_script() {
    ...
    assert_script(
        ...
        r#"
  neighbours n=4
    [0] fts=1 lts=1 obj=item14 nshape=Box[-1600,-100..-400,1100] nshapeCorners=(-1600,-100;-400,-100;-400,1100;-1600,1100) isect=Box[-1600,-100..-1600,1100] isectCorners=(-1600,-100;-1600,-100;-1600,1100;-1600,1100)
    [1] fts=1 lts=2 obj=cfsr2 nshape=Box[-1858,6349..-1018,7935] nshapeCorners=(-1858,6349;-1018,6349;-1018,7935;-1858,7935) isect=Box[-1858,6349..-1600,6349] isectCorners=(-1858,6349;-1600,6349;-1600,6349;-1858,6349)
    [2] fts=3 lts=3 obj=item25 nshape=Box[-6600,-600..-5900,1100] nshapeCorners=(-6600,-600;-5900,-600;-5900,1100;-6600,1100) isect=Box[-5900,-600..-5900,1100] isectCorners=(-5900,-600;-5900,-600;-5900,1100;-5900,1100)
    [3] fts=3 lts=0 obj=item23 nshape=Box[-6100,-5100..-4900,-3900] nshapeCorners=(-6100,-5100;-4900,-5100;-4900,-3900;-6100,-3900) isect=Box[-5900,-3900..-4900,-3900] isectCorners=(-5900,-3900;-4900,-3900;-4900,-3900;-5900,-3900)
  edgeTouches=[true,true,true,true]
  completedRoom=cfsr8
  doors n=1
    [0] first=cfsr8 second=cfsr2 dim=1 shape=Box[-1858,6349..-1600,6349] corners=(-1858,6349;-1600,6349;-1600,6349;-1858,6349)
  targetDoors n=0
"#,
    );
}
...
fn an_own_net_object_becomes_a_target_door_inside_the_neighbour_loop() {
    ...
    assert_script(
        ...
        r#"
  neighbours n=3
    [0] fts=0 lts=0 obj=item13 nshape=Box[4400,-5600..5100,-3400] nshapeCorners=(4400,-5600;5100,-5600;5100,-3400;4400,-3400) isect=Box[4400,-3400..5100,-3400] isectCorners=(4400,-3400;5100,-3400;5100,-3400;4400,-3400)
    [1] fts=2 lts=2 obj=item21 nshape=Box[2900,2900..5100,3600] nshapeCorners=(2900,2900;5100,2900;5100,3600;2900,3600) isect=Box[2900,2900..5100,2900] isectCorners=(2900,2900;5100,2900;5100,2900;2900,2900)
    [2] fts=3 lts=3 obj=item14 nshape=Box[-1600,-100..-400,1100] nshapeCorners=(-1600,-100;-400,-100;-400,1100;-1600,1100) isect=Box[-400,-100..-400,1100] isectCorners=(-400,-100;-400,-100;-400,1100;-400,1100)
...
fn an_eight_sided_obstacle_room_gets_eight_doors() {
    ...
    assert_script(
        &actual,
        r#"
  result=obs5/0 shape=Oct[-1340,-240,-260,1440,-2464,-336,-1264,864] corners=(-1024,-240;-576,-240;-260,76;-260,1124;-576,1440;-1024,1440;-1340,1124;-1340,76)
  doors n=9
    [0] first=obs5/0 second=obs5/1 dim=2 shape=Oct[-1340,360,-260,1440,-2464,-620,-664,864] corners=(-1024,360;-260,360;-260,360;-260,1124;-576,1440;-1024,1440;-1340,1124;-1340,676)
    [1] first=obs5/0 second=inc8 dim=1 shape=Oct[-1024,-240,-576,-240,-784,-336,-1264,-816] corners=(-1024,-240;-576,-240;-576,-240;-576,-240;-576,-240;-1024,-240;-1024,-240;-1024,-240)
    [2] first=obs5/0 second=inc9 dim=1 shape=Oct[-576,-240,-260,76,-336,-336,-816,-184] corners=(-576,-240;-576,-240;-260,76;-260,76;-260,76;-260,76;-576,-240;-576,-240)
    [3] first=obs5/0 second=inc10 dim=1 shape=Oct[-260,76,-260,1124,-1384,-336,-184,864] corners=(-260,76;-260,76;-260,76;-260,1124;-260,1124;-260,1124;-260,1124;-260,76)
    [4] first=obs5/0 second=inc11 dim=1 shape=Oct[-576,1124,-260,1440,-2016,-1384,864,864] corners=(-260,1124;-260,1124;-260,1124;-260,1124;-576,1440;-576,1440;-576,1440;-576,1440)
    [5] first=obs5/0 second=inc12 dim=1 shape=Oct[-1024,1440,-576,1440,-2464,-2016,416,864] corners=(-1024,1440;-576,1440;-576,1440;-576,1440;-576,1440;-1024,1440;-1024,1440;-1024,1440)
    [6] first=obs5/0 second=inc13 dim=1 shape=Oct[-1340,1124,-1024,1440,-2464,-2464,-216,416] corners=(-1340,1124;-1340,1124;-1024,1440;-1024,1440;-1024,1440;-1024,1440;-1340,1124;-1340,1124)
    [7] first=obs5/0 second=inc14 dim=1 shape=Oct[-1340,76,-1340,1124,-2464,-1416,-1264,-216] corners=(-1340,76;-1340,76;-1340,76;-1340,1124;-1340,1124;-1340,1124;-1340,1124;-1340,76)
    [8] first=obs5/0 second=inc15 dim=1 shape=Oct[-1340,-240,-1024,76,-1416,-784,-1264,-1264] corners=(-1024,-240;-1024,-240;-1024,-240;-1024,-240;-1340,76;-1340,76;-1340,76;-1340,76)
  targetDoors n=0
  incompleteRooms n=8
    [0] layer=0 shape=Oct[-10000,-10000,10000,-240,-9760,20000,-20000,9760] corners=(-10000,-10000;10000,-10000;10000,-10000;10000,-240;10000,-240;-10000,-240;-10000,-240;-10000,-10000) contained=Oct[-1024,-240,-576,-240,-784,-336,-1264,-816] doors=1
    [1] layer=0 shape=Oct[-10000,-10000,10000,10000,-336,20000,-20000,20000] corners=(-10000,-10000;10000,-10000;10000,-10000;10000,10000;10000,10000;9664,10000;-10000,-9664;-10000,-10000) contained=Oct[-576,-240,-260,76,-336,-336,-816,-184] doors=1
    [2] layer=0 shape=Oct[-260,-10000,10000,10000,-10260,20000,-10260,20000] corners=(-260,-10000;10000,-10000;10000,-10000;10000,10000;10000,10000;-260,10000;-260,10000;-260,-10000) contained=Oct[-260,76,-260,1124,-1384,-336,-184,864] doors=1
    [3] layer=0 shape=Oct[-9136,-9136,10000,10000,-19136,19136,864,20000] corners=(10000,-9136;10000,-9136;10000,-9136;10000,10000;10000,10000;-9136,10000;-9136,10000;-9136,10000) contained=Oct[-576,1124,-260,1440,-2016,-1384,864,864] doors=1
    [4] layer=0 shape=Oct[-10000,1440,10000,10000,-20000,8560,-8560,20000] corners=(-10000,1440;10000,1440;10000,1440;10000,10000;10000,10000;-10000,10000;-10000,10000;-10000,1440) contained=Oct[-1024,1440,-576,1440,-2464,-2016,416,864] doors=1
    [5] layer=0 shape=Oct[-10000,-7536,7536,10000,-20000,-2464,-17536,17536] corners=(-10000,-7536;-10000,-7536;7536,10000;7536,10000;7536,10000;-10000,10000;-10000,10000;-10000,-7536) contained=Oct[-1340,1124,-1024,1440,-2464,-2464,-216,416] doors=1
    [6] layer=0 shape=Oct[-10000,-10000,-1340,10000,-20000,8660,-20000,8660] corners=(-10000,-10000;-1340,-10000;-1340,-10000;-1340,10000;-1340,10000;-10000,10000;-10000,10000;-10000,-10000) contained=Oct[-1340,76,-1340,1124,-2464,-1416,-1264,-216] doors=1
    [7] layer=0 shape=Oct[-10000,-10000,8736,8736,-18736,18736,-20000,-1264] corners=(-10000,-10000;8736,-10000;8736,-10000;8736,-10000;-10000,8736;-10000,8736;-10000,8736;-10000,-10000) contained=Oct[-1340,-240,-1024,76,-1416,-784,-1264,-1264] doors=1
"#,
    );
...
fn an_orthogonal_obstacle_room_with_no_neighbours_gets_one_room_per_board_side() {
    ...
    assert_script(
        &actual,
        r#"
  result=obs2/0 shape=Box[-650,-150..-350,150] corners=(-650,-150;-350,-150;-350,150;-650,150)
  doors n=4
    [0] first=obs2/0 second=inc8 dim=1 shape=Box[-650,-150..-350,-150] corners=(-650,-150;-350,-150;-350,-150;-650,-150)
    [1] first=obs2/0 second=inc9 dim=1 shape=Box[-350,-150..-350,150] corners=(-350,-150;-350,-150;-350,150;-350,150)
    [2] first=obs2/0 second=inc10 dim=1 shape=Box[-650,150..-350,150] corners=(-650,150;-350,150;-350,150;-650,150)
    [3] first=obs2/0 second=inc11 dim=1 shape=Box[-650,-150..-650,150] corners=(-650,-150;-650,-150;-650,150;-650,150)
  targetDoors n=0
  incompleteRooms n=4
    [0] layer=0 shape=Box[-10000,-10000..10000,-150] corners=(-10000,-10000;10000,-10000;10000,-150;-10000,-150) contained=Box[-650,-150..-350,-150] doors=1
    [1] layer=0 shape=Box[-350,-10000..10000,10000] corners=(-350,-10000;10000,-10000;10000,10000;-350,10000) contained=Box[-350,-150..-350,150] doors=1
    [2] layer=0 shape=Box[-10000,150..10000,10000] corners=(-10000,150;10000,150;10000,10000;-10000,10000) contained=Box[-650,150..-350,150] doors=1
    [3] layer=0 shape=Box[-10000,-10000..-650,10000] corners=(-10000,-10000;-650,-10000;-650,10000;-10000,10000) contained=Box[-650,-150..-650,150] doors=1
"#,
    );
}
...
fn a_two_dimensional_overlap_is_a_45_degree_neighbour_with_a_two_dimensional_door() {
    ...
    assert_script(
        ...
        r#"
  neighbours n=1
    [0] fts=2 lts=4 obj=cfsr1004 nshape=Oct[-2500,-8500,500,-6500,4000,9000,-11000,-6000] nshapeCorners=(-2500,-8500;500,-8500;500,-8500;500,-6500;500,-6500;-2500,-6500;-2500,-6500;-2500,-8500) isect=Oct[-2500,-8500,-1000,-7500,5000,7500,-11000,-8500] isectCorners=(-2500,-8500;-1000,-8500;-1000,-8500;-1000,-7500;-1000,-7500;-2500,-7500;-2500,-7500;-2500,-8500)
  edgeTouches=[false,false,true,true,true,false,false,false]
  completedRoom=cfsr1005
  doors n=1
    [0] first=cfsr1005 second=cfsr1004 dim=2 shape=Box[-2500,-8500..-1000,-7500] corners=(-2500,-8500;-1000,-8500;-1000,-7500;-2500,-7500)
  targetDoors n=0
"#,
    );
...
fn a_two_dimensional_overlap_is_an_orthogonal_neighbour_with_a_two_dimensional_door() {
    ...
    assert_script(
        ...
        r#"
  neighbours n=1
    [0] fts=1 lts=2 obj=cfsr1004 nshape=Box[-2500,-8500..500,-6500] nshapeCorners=(-2500,-8500;500,-8500;500,-6500;-2500,-6500) isect=Box[-2500,-8500..-1000,-7500] isectCorners=(-2500,-8500;-1000,-8500;-1000,-7500;-2500,-7500)
...
type Neighbour45 = copper_router::autoroute::expansion::sorted_neighbours_45::SortedRoomNeighbour;
type NeighbourOrthogonal =
    copper_router::autoroute::expansion::sorted_neighbours_orthogonal::SortedRoomNeighbour;
