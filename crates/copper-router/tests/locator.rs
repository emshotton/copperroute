...
use copper_router::autoroute::maze::search::MazeResult;
use copper_router::autoroute::maze::search::MazeSearchEngine;
use copper_router::autoroute::path::{
...
#[test]
fn the_additional_corner_of_every_regime_is_computed_correctly() {
...
fn format_point(point: FloatPoint) -> String {
    format!("({},{})", format_double(point.x), format_double(point.y))
}
