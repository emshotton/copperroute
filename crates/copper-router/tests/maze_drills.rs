...
use copper_router::arena::PageId;
use copper_router::autoroute::drill::ExpansionDrill;
use copper_router::autoroute::expansion::{ExpandableRef, RoomRef};
use copper_router::autoroute::maze::engine::AutorouteEngine;
use copper_router::autoroute::maze::expansion_engine::MazeExpansionEngine;
use copper_router::autoroute::maze::search::MazeSearchEngine;
use copper_router::autoroute::maze::{AutorouteControl, MazeAdjustment, MazeListElement, ViaMask};
use copper_router::board_ext::CheckDrillResult;
...
fn an_attach_smd_via_promotes_the_layer_and_the_via_mask_then_decides_the_span() {
    ...
    let drill_id = copper_router::arena::DrillId(maze.engine.rooms.drills.insert(drill));
    assert_eq!(
        drill_rooms
            .iter()
...
fn an_obstacle_via_room_expands_only_when_ripup_is_allowed_and_marks_the_element_ripped() {
    ...
    .expect("init succeeds");
    let via_drill = copper_router::autoroute::maze::expansion_engine::via_autoroute_drill_info(
        maze.engine,
        &mut fixture.board,
        ItemId(7),
    )
