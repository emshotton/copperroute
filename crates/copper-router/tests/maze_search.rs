...
use copper_board::rules::ViaRule;
use copper_geometry::{
...
use copper_router::autoroute::maze::search::{
    MazeSearchEngine, segment_projection, to_impacted_points,
};
use copper_router::autoroute::maze::{AutorouteControl, MazeListElement};
...
fn the_queue_pops_the_lowest_sorting_value_and_removes_it() {
    ...
    maze.push(
        MazeListElement {
            ...
            room_ripped: false,
            adjustment: copper_router::autoroute::maze::MazeAdjustment::None,
