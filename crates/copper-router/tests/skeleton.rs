...
use copper_router::{Arena, AutorouteAttemptResult, AutorouteAttemptState, ExpansionCostFactor};
...
fn expansion_cost_factor_is_the_one_from_fr_settings() {
    assert_eq!(
        ...
        TypeId::of::<copper_settings::ExpansionCostFactor>()
    );
    let from_settings = copper_settings::ExpansionCostFactor {
        horizontal: 1.5,
        vertical: 2.5,
    };
