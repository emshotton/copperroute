...
use copper_board::{Board, BoardError, ItemId};
...
impl<'a> BatchAutorouter<'a> {
    ...
    pub const ID: &'static str = "copperroute-router";
    pub const NAME: &'static str = "Copperroute Auto-router";
    pub const VERSION: &'static str = "1.0";
    pub const DESCRIPTION: &'static str = "Copperroute Auto-router v1.0";
    ...
    pub fn autoroute_item(
        ...
        set_route_context(
            if self.is_optimizer_autorouter {
                RoutingPhase::Optimizer
            } else {
                RoutingPhase::Autorouter
            },
            ripup_pass_no,
        );
