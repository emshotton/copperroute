...
use copper_board::{Board, ItemId, StopConnectionOption};
use copper_drc::{DesignRulesChecker, PlaneConnectivity};
...
impl BatchOptimizer<'_> {
    pub const ID: &'static str = "copperroute-optimizer";
    pub const NAME: &'static str = "Copperroute Optimizer";
    pub const VERSION: &'static str = "1.0";
    pub const DESCRIPTION: &'static str = "Copperroute Optimizer v1.0";
