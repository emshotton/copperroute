...
mod tests {
    ...
    use copper_board::ids::{PadstackId, ViaInfoId};
    use copper_board::prelude::*;
    use copper_board::rules::{ViaInfo, ViaRule};
    use copper_geometry::{
        IntBox, IntOctagon, IntPoint, IntVector, Point, Polyline, Shape, TileShape,
    };
    ...
    /// `P6T15Probe.ln`.
    fn line_of(line: &copper_geometry::Line) -> String {
    ...
    // `crates/copper-router/tests/inserter.rs`. They live here for the reason that file's own module
