...
use copper_board::structure::AngleRestriction;
use copper_board::{Board, Item, ItemId, TreeId};
use copper_geometry::{FloatPoint, IntPoint, TileShape};
...
impl FoundConnectionLocator {
    ...
    fn new(
        ...
        let mut walk = LocatorWalk {
            ...
            current_target_shape: TileShape::Simplex(copper_geometry::Simplex::EMPTY),
            next_corner_id: 1,
        };
