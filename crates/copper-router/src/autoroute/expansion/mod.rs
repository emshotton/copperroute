...
use copper_board::{Board, ItemId, ObstacleRoomId, RoomId, TreeId, TreeObject};
use copper_geometry::{FloatLine, TileShape};
...
impl copper_board::RoomLookup for ExpansionRoomStore {
...
mod tests {
    ...
    fn bare_tree() -> ShapeSearchTree {
        ShapeSearchTree::new(
            copper_board::TreeId(0),
            copper_board::structure::AngleRestriction::NinetyDegree,
            0,
        )
    }
