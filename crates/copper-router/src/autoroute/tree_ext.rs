...
use copper_board::{AngleRestriction, ItemCtx, ItemLookup, Node, NodeId, ShapeSearchTree};
use copper_geometry::{IntBox, IntOctagon, Line, LineSegment, RegularTileShape, Side, TileShape};
...
fn item_of(items: &impl ItemLookup, id: copper_board::ItemId) -> &copper_board::Item {
...
enum ResolvedTreeObject<'a> {
    Item(copper_board::ItemId, &'a copper_board::Item),
    Room(
        copper_board::RoomId,
