...
pub struct FanoutSettings {
    ...
    #[serde(rename = "max_milliseconds_per_pin")]
    ...
    #[serde(rename = "start_via_diameter_mm")]
    ...
    #[serde(rename = "end_via_diameter_mm")]
    ...
    #[serde(rename = "pin_sorting_order")]
    ...
    #[serde(rename = "fallback_to_board_vias")]
