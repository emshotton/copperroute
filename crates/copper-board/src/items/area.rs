...
use copper_geometry::{Area, FloatPoint, IntBox, IntPoint, Point, TileShape, Vector};
...
mod tests {
    ...
    fn partial_eq_ignores_the_absolute_area_memo() {
        ...
        let data = || {
            ObstacleAreaData::new(
                Area::Shape(copper_geometry::Shape::Tile(TileShape::Box(
        ...
        let b = data();
        a.absolute_area
            .set(Area::Shape(copper_geometry::Shape::Tile(TileShape::Box(
