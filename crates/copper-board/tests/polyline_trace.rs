...
use copper_geometry::{
    FloatPoint, IntBox, IntPoint, IntVector, Point, Polyline, TileShape, Vector,
};
...
fn split_polyline_at_line_is_the_private_java_overload() {
    let t = trace(1, two_point_polyline(), 0, 1000);
    let vertical = copper_geometry::Line::new(IntPoint::new(15_000, 0), IntPoint::new(15_000, 1));
    let pieces = t
    ...
    let horizontal = copper_geometry::Line::new(IntPoint::new(0, 10_000), IntPoint::new(1, 10_000));
