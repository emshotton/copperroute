...
use copper_geometry::{Area, FloatPoint, IntPoint, Point, PolygonShape, Shape, Vector};
...
struct Fixture {
    ...
    rules: BoardRules,
    bounding_box: copper_geometry::IntBox,
}
...
impl Fixture {
    fn new() -> Fixture {
        ...
        Fixture {
            ...
            bounding_box: copper_geometry::IntBox::from_coords(0, 0, 1000, 1000),
        }
    }
