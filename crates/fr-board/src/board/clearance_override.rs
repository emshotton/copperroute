...
// renamed: `HeadlessBoardManager.loadFromKiCadJson` (:794-823) -> `fr_core::load_from_kicad_json` (Plan 8 Task 3), over `fr_dsn::kicad::read_board` (Plan 8 Task 9, which replaced Task 3's stub).
