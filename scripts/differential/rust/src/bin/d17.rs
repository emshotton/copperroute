use copper_geometry::circle::Circle;
...
use copper_geometry::polygon_shape::PolygonShape;
use copper_geometry::polyline_area::PolylineArea;
use copper_geometry::polyline_shape::PolylineShapeOps;
use copper_geometry::shape::{Shape, ShapeOps};
