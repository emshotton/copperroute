...
### PR #26 rebase onto default-corridor main

Unchanged original neckdown patch reapplied onto736d02d; full workspace2609checks including children/77ignored/0failed. Full KiCad-only run quality-epyc-pr26-rebased-full-01:1502valid scores, all files checksum-verified on workbench before releasing temporary server. PCBench740:−197U (23better/3worse),+45copper (13gainers),CPU0.9474; local11:−7U (1better/0worse),+7copper (1gainer),CPU1.0083. Completed PC713:−35U (11better/1worse),+32copper (9gainers),CPU0.9339; local10:−7U/+7copper,CPU1.0132. Total completed723:−42U/+39copper. Known artwork outliers do not explain regressions; KiCad finds below-minimum widths across ordinary boards and undersized new vias on oasis_ledboard. FreeDSP goes0→2U with no established outlier explanation. Keep draft; rebasing does not make this a mergeable quality improvement. Full evidence and report: pr26-rebased-assessment.md.
