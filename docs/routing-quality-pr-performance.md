## Benchmark: change vs main

**worse** — the regression gate **fails**:

- change: 8 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 845 of 845 shared |
| Wins / losses / ties | 495 / 311 / 39 |
| Quality losses | 8 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.59 → 0.60 |
| Median Δscore | 0.0 |
| Median time ratio | 1.00 |

<details><summary>806 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +8 | 0 | -51.3 | -0.4 |
| pcbench-ReSDMAC_ReSDMAC | loss (unrouted) | +3 | 0 | -15.2 | -0.6 |
| issue103-board-unrouted | loss (unrouted) | +4 | 0 | -14.2 | -0.1 |
| pcbench-karabas-nano_karabas-nano-revG | loss (unrouted) | +1 | 0 | -4.9 | -0.4 |
| issue754-avionics_hub | loss (unrouted) | +1 | 0 | -2.7 | 0.0 |
| issue420-contribution-board | loss (unrouted) | +1 | 0 | -2.4 | -0.9 |
| pcbench-karabas-nano_karabas-nano-revA | loss (score) | 0 | 0 | -0.0 | -0.3 |
| dac2020-bm05 | loss (cpu_s) | 0 | 0 | 0.0 | +0.8 |
| dac2020-bm07 | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| issue026-j2_reference | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| issue035-readplacescope | loss (cpu_s) | 0 | 0 | 0.0 | +0.5 |
| issue107-freq_teiler_200khz_kicad | loss (cpu_s) | 0 | 0 | 0.0 | +0.7 |
| issue107-freq_teiler_200khz_kicad_bad | loss (cpu_s) | 0 | 0 | 0.0 | +0.4 |
| issue110-testpcbspecctrafile | loss (cpu_s) | 0 | 0 | 0.0 | +1.4 |
| issue110-testprojectfromfreeroutingbugtest | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| issue110-testprojectfromfreeroutingbugtest01 | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| issue143-rpi_splitter_mod | loss (peak_rss_mb) | 0 | 0 | 0.0 | 0.0 |
| issue163-pic_programmer | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| issue209-split05 | loss (cpu_s) | 0 | 0 | 0.0 | +2.1 |
| issue230-cnh_functional_tester_1 | loss (cpu_s) | 0 | 0 | 0.0 | +0.7 |
| … | and 786 more | | | | |

</details>

Baseline first: main `6886640` · change `26595d8-projection-62fab1ae`

threads=1 jobs=96 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-pr-main-6886640.

**Caveats**

- seeds=1 (<3), so the noise floor is unmeasured and timing differences here are not evidence.
- 7 failed cells; see the full report.
- dac2020-bm01: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm02: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm04: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm05: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm06: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm07: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm08: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm09: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm10: baseline has 1 judged repetition(s); noise is unmeasured
- dac2020-bm11: baseline has 1 judged repetition(s); noise is unmeasured
- empty_board: baseline has 1 judged repetition(s); noise is unmeasured
- empty_board/change: no positive score denominator; score comparison omitted
- issue006-lpc18xx_43xx_sch: baseline has 1 judged repetition(s); noise is unmeasured
- issue006-lpc18xx_43xx_sch/change: no positive score denominator; score comparison omitted
- issue015-stackoverflow: baseline has 1 judged repetition(s); noise is unmeasured
- issue022-autorouter_interrupted: baseline has 1 judged repetition(s); noise is unmeasured
- issue026-j2_reference: baseline has 1 judged repetition(s); noise is unmeasured
- issue027-zmretestfixture: baseline has 1 judged repetition(s); noise is unmeasured
- issue029-hw48na: baseline has 1 judged repetition(s); noise is unmeasured
- issue034-green14segled: baseline has 1 judged repetition(s); noise is unmeasured
- issue035-readplacescope: baseline has 1 judged repetition(s); noise is unmeasured
- issue039-bug-design: baseline has 1 judged repetition(s); noise is unmeasured
- issue054-tairakb: baseline has 1 judged repetition(s); noise is unmeasured
- issue066-project_gp8b: baseline has 1 judged repetition(s); noise is unmeasured
- issue070-autorouter_fq101_pcb_2022-05-13: baseline has 1 judged repetition(s); noise is unmeasured
- issue093-interf_u: baseline has 1 judged repetition(s); noise is unmeasured
- issue102-mars-64-reve-rot00: baseline has 1 judged repetition(s); noise is unmeasured
- issue103-board-routed: baseline has 1 judged repetition(s); noise is unmeasured
- issue103-board-unrouted: baseline has 1 judged repetition(s); noise is unmeasured
- issue107-freq_teiler_200khz_kicad: baseline has 1 judged repetition(s); noise is unmeasured
- issue107-freq_teiler_200khz_kicad_bad: baseline has 1 judged repetition(s); noise is unmeasured
- issue110-pajalnaja_stancija: baseline has 1 judged repetition(s); noise is unmeasured
- issue110-relaymodule: baseline has 1 judged repetition(s); noise is unmeasured
- issue110-testpcbspecctrafile: baseline has 1 judged repetition(s); noise is unmeasured
- issue110-testprojectfromfreeroutingbugtest: baseline has 1 judged repetition(s); noise is unmeasured
- issue110-testprojectfromfreeroutingbugtest01: baseline has 1 judged repetition(s); noise is unmeasured
- issue110-паяльная станция: baseline has 1 judged repetition(s); noise is unmeasured
- issue113-protein: baseline has 1 judged repetition(s); noise is unmeasured
- issue143-rpi_splitter: baseline has 1 judged repetition(s); noise is unmeasured
- issue143-rpi_splitter_mod: baseline has 1 judged repetition(s); noise is unmeasured
- issue145-smoothieboard: baseline has 1 judged repetition(s); noise is unmeasured
- issue153-wavefolder: baseline has 1 judged repetition(s); noise is unmeasured
- issue155-ch376_mcp795_module: baseline has 1 judged repetition(s); noise is unmeasured
- issue157-teamadapt-linepcb: baseline has 1 judged repetition(s); noise is unmeasured
- issue159-setonix_2hp-pcb: baseline has 1 judged repetition(s); noise is unmeasured
- issue163-pic_programmer: baseline has 1 judged repetition(s); noise is unmeasured
- issue178-keebmaker_sofle_choc: baseline has 1 judged repetition(s); noise is unmeasured
- issue179-autorouter_pcb1_2023-3-24: baseline has 1 judged repetition(s); noise is unmeasured
- issue187-processor.z80: baseline has 1 judged repetition(s); noise is unmeasured
- issue190-processor.z80: baseline has 1 judged repetition(s); noise is unmeasured
- issue208-freerouting: baseline has 1 judged repetition(s); noise is unmeasured
- issue209-split05: baseline has 1 judged repetition(s); noise is unmeasured
- issue209-split10: baseline has 1 judged repetition(s); noise is unmeasured
- issue214-freerouting: baseline has 1 judged repetition(s); noise is unmeasured
- issue217-8088sbc: baseline has 1 judged repetition(s); noise is unmeasured
- issue219-logicboard_smt: baseline has 1 judged repetition(s); noise is unmeasured
- issue229-display-8-digit-hc595: baseline has 1 judged repetition(s); noise is unmeasured
- issue230-cnh_functional_tester_1: baseline has 1 judged repetition(s); noise is unmeasured
- issue269-caniot-tiny-arm: baseline has 1 judged repetition(s); noise is unmeasured
- issue269-z10_module: baseline has 1 judged repetition(s); noise is unmeasured
- issue270-non-ansi_bracket: baseline has 1 judged repetition(s); noise is unmeasured
- issue289-autorouter_pcb_fht-8086_2024-03-08: baseline has 1 judged repetition(s); noise is unmeasured
- issue289-autorouter_pcb_fht-vga_2024-03-25: baseline has 1 judged repetition(s); noise is unmeasured
- issue297-myboard: baseline has 1 judged repetition(s); noise is unmeasured
- issue313-fasttest: baseline has 1 judged repetition(s); noise is unmeasured
- issue326-mars-64-reve: baseline has 1 judged repetition(s); noise is unmeasured
- issue367-charger: baseline has 1 judged repetition(s); noise is unmeasured
- issue368-corneyislandwireless_input_design: baseline has 1 judged repetition(s); noise is unmeasured
- issue413-test: baseline has 1 judged repetition(s); noise is unmeasured
- issue420-contribution-board: baseline has 1 judged repetition(s); noise is unmeasured
- issue433-my-board: baseline has 1 judged repetition(s); noise is unmeasured
- issue508-smd-routing-issue-demo: baseline has 1 judged repetition(s); noise is unmeasured
- issue555-bbd_mars-64: baseline has 1 judged repetition(s); noise is unmeasured
- issue555-cnh_functional_tester_1: baseline has 1 judged repetition(s); noise is unmeasured
- issue558-dev-board: baseline has 1 judged repetition(s); noise is unmeasured
- issue575-drc_bbd_mars-64_6_track_1_hole_clearance_violations: baseline has 1 judged repetition(s); noise is unmeasured
- issue575-drc_dev-board_4_hole_clearance_violations: baseline has 1 judged repetition(s); noise is unmeasured
- issue575-drc_natural_tone_preamp_7_unconnected_items: baseline has 1 judged repetition(s); noise is unmeasured
- issue593-bbd_mars-64: baseline has 1 judged repetition(s); noise is unmeasured
- issue649-kicad_ecc83-pp_input_board_v1: baseline has 1 judged repetition(s); noise is unmeasured
- issue649-kicad_ecc83-pp_input_board_v2: baseline has 1 judged repetition(s); noise is unmeasured
- issue676-ch32v-tx118s: baseline has 1 judged repetition(s); noise is unmeasured
- issue684-autorouter_pcb1_2026-5-8: baseline has 1 judged repetition(s); noise is unmeasured
- issue689-bbd_mars-64: baseline has 1 judged repetition(s); noise is unmeasured
- issue690-ecc83: baseline has 1 judged repetition(s); noise is unmeasured
- issue690-kit-dev-coldfire-xilinx_5213: baseline has 1 judged repetition(s); noise is unmeasured
- issue690-sonde_xilinx: baseline has 1 judged repetition(s); noise is unmeasured
- issue721-autorouter_ce2632_harrymu_2026-6-15: baseline has 1 judged repetition(s); noise is unmeasured
- issue723-combinestackoverflow: baseline has 1 judged repetition(s); noise is unmeasured
- issue730-dac2020_bm11: baseline has 1 judged repetition(s); noise is unmeasured
- issue732-cm5_minima_3: baseline has 1 judged repetition(s); noise is unmeasured
- issue732-dac2020_bm10: baseline has 1 judged repetition(s); noise is unmeasured
- issue732-royalblue54l-feather: baseline has 1 judged repetition(s); noise is unmeasured
- issue733-kicad_complex_hierarchy_input_design: baseline has 1 judged repetition(s); noise is unmeasured
- issue733-kicad_interf_u_input_design: baseline has 1 judged repetition(s); noise is unmeasured
- issue742-tastexx-pcb: baseline has 1 judged repetition(s); noise is unmeasured
- issue753-cpu-85_r104: baseline has 1 judged repetition(s); noise is unmeasured
- issue754-avionics_hub: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-minimal-hang: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-minimal-ok: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-tomu-fpga: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-tomu-fpga11: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-tomu-fpga7: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-tomu-fpga8: baseline has 1 judged repetition(s); noise is unmeasured
- issue756-tomu-fpga9: baseline has 1 judged repetition(s); noise is unmeasured
- issue757-minimal-soe: baseline has 1 judged repetition(s); noise is unmeasured
- issue757-minimal-soe-ok: baseline has 1 judged repetition(s); noise is unmeasured
...
<sub>Generated by `uv run bench pr-summary --compare quality-pr-main-6886640` from `reports/quality-pr-main-6886640.json`.</sub>
