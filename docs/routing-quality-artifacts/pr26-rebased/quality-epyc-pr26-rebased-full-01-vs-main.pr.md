## Benchmark: neckdown vs main

**worse** — the regression gate **fails**:

- neckdown: 24 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 243 / 472 / 36 |
| Quality losses | 24 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.76 → 0.76 |
| Median Δscore | 0.0 |
| Median time ratio | 1.01 |

<details><summary>715 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-freeDSP-CLASSIC-SMD-BALANCED_FreeDSP_BAL | loss (clean_pass_rate) | +2 | 0 | -13.5 | -58.9 |
| pcbench-kinetoscope_sram-bank | loss (unrouted) | +2 | 0 | -13.0 | +0.9 |
| pcbench-Hardware_Playground_serial_gw_ATMEGA328P | loss (violations) | 0 | +2 | -12.1 | +7.7 |
| pcbench-LPC2148_Stick_LPC2148_stick | loss (clean_pass_rate) | 0 | +3 | -6.2 | -29.2 |
| pcbench-LPC2148_Stick__autosave-LPC2148_stick | loss (clean_pass_rate) | 0 | +3 | -6.2 | -26.6 |
| pcbench-DerKnopf_digi-pot | loss (clean_pass_rate) | 0 | +1 | -4.1 | -1.6 |
| pcbench-avr_ledprojector_avr_ledprojection-0402 | loss (violations) | 0 | +2 | -3.8 | +45.1 |
| pcbench-motor-3xdrv8833-hw_ver1 | loss (clean_pass_rate) | 0 | +1 | -2.7 | -18.5 |
| pcbench-eink-adapter_eink | loss (score) | 0 | 0 | -0.0 | -51.5 |
| pcbench-STM32F303_LQFP48_STM32_LQFP48 | loss (score) | 0 | 0 | -0.0 | -7.6 |
| pcbench-can_firewall_hardware_CAN_Firewall | loss (score) | 0 | 0 | -0.0 | -22.3 |
| pcbench-wavegen_waveform-generator | loss (score) | 0 | 0 | -0.0 | -42.5 |
| pcbench-STM32F373_LQFP48_STM32_LQFP48 | loss (score) | 0 | 0 | -0.0 | +18.5 |
| pcbench-Electronics-MainBoard_MainBoard | loss (score) | 0 | 0 | -0.0 | +13.6 |
| pcbench-RX5808_diversityModule | loss (score) | 0 | 0 | -0.0 | -0.5 |
| pcbench-SNAP-Badge_SNAP_badge | loss (score) | 0 | 0 | -0.0 | +16.6 |
| pcbench-pusheenz40_sadcatz40 | loss (score) | 0 | 0 | -0.0 | +1.4 |
| pcbench-divergence_meter_dm_control | loss (score) | 0 | 0 | -0.0 | +6.4 |
| pcbench-CoreOne-xCORE200-Original_CoreOne | loss (score) | 0 | 0 | -0.0 | +0.4 |
| pcbench-eeg_brainboard_batteryv0 | loss (score) | 0 | 0 | -0.0 | -4.2 |
| … | and 695 more | | | | |

</details>

Baseline first: main `736d02d+main` · neckdown `736d02d+neckdown`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-pr26-rebased-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-pr26-rebased-full-01-vs-main` from `reports/quality-epyc-pr26-rebased-full-01-vs-main.json`.</sub>
