## Benchmark: rounded-copper vs main

**worse** — the regression gate **fails**:

- rounded-copper: 6 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 459 / 261 / 31 |
| Quality losses | 6 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.74 → 0.74 |
| Median Δscore | 0.0 |
| Median time ratio | 0.99 |

<details><summary>720 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-karabas-nano_karabas-nano-revC | loss (unrouted) | +4 | 0 | -21.2 | +0.1 |
| pcbench-kitspace_dropbot-front-panel | loss (clean_pass_rate) | +2 | 0 | -14.0 | +0.1 |
| pcbench-bms-8s50-ic_bms-8s50-ic | loss (unrouted) | +1 | 0 | -7.0 | +0.1 |
| pcbench-rjw57_cpu-board | loss (score) | 0 | 0 | -0.0 | -0.0 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +2.1 |
| kicad-issue269-min_fr_test--min_fr_test | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue269-noviasonpowerplanes--issue269-noviasonpowerplanes | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue368-corneyislandwireless--corney_island_wireless | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| kicad-issue558-dev-board-autoroute-demo--dev-board | loss (cpu_s) | 0 | 0 | 0.0 | +3.4 |
| kicad-issue632-miniautopilot--mini auto pilot | loss (cpu_s) | 0 | 0 | 0.0 | +0.6 |
| kicad-issue742-tastexx-pcb--tastexx-pcb | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| pcbench-1-Wire-Wing-pcb_1-Wire_Wing | loss (cpu_s) | 0 | 0 | 0.0 | +2.7 |
| pcbench-12v-automatic-ups_ups-12v | loss (cpu_s) | 0 | 0 | 0.0 | +4.3 |
| pcbench-16x12-bits-I2C_I2C_Servo | loss (cpu_s) | 0 | 0 | 0.0 | +2.2 |
| pcbench-2d_conduction_sk9822-matrix | loss (cpu_s) | 0 | 0 | 0.0 | +20.8 |
| pcbench-4N35-TTL-Serial-Optoisolator_4N35-TTL-Serial-Optoisolator | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-655_testboard | loss (cpu_s) | 0 | 0 | 0.0 | +1.6 |
| pcbench-6N137-TTL-Serial-Optoisolator_6N137-TTL-Serial-Optoisolator | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-6volt-5W-solar-cc_6vleadacidsolar | loss (cpu_s) | 0 | 0 | 0.0 | +7.3 |
| … | and 700 more | | | | |

</details>

Baseline first: main `5c4a5c94` · rounded-copper `rounded-copper-v1`

threads=1 jobs=12 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs rounded-copper-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare rounded-copper-full-01` from `reports/rounded-copper-full-01.json`.</sub>
