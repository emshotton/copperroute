## Benchmark: holes vs main

**worse** — the regression gate **fails**:

- holes: 7 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 380 / 355 / 16 |
| Quality losses | 7 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.74 → 0.75 |
| Median Δscore | 0.0 |
...
|---|---|---|---|---|---|
| pcbench-EncoderBoard_Enc_Pan_Led | loss (clean_pass_rate) | +1 | 0 | -22.7 | +3.7 |
| pcbench-CoreOne-xCORE200-Original_CoreOne | loss (unrouted) | +4 | -1 | -15.5 | +1.0 |
| pcbench-ReSDMAC_ReSDMAC | loss (unrouted) | +1 | 0 | -5.0 | +0.1 |
| pcbench-ADC-PCM4202-SE_ADC-PCM4202-SE | loss (score) | 0 | 0 | -0.0 | -6.2 |
| pcbench-rjw57_cpu-board | loss (score) | 0 | 0 | -0.0 | -6.6 |
| pcbench-pusheenz40_sadcatz40 | loss (score) | 0 | 0 | -0.0 | +1.6 |
| pcbench-LED-Square_PT4115_LED-Square_PT4115 | loss (score) | 0 | 0 | -0.0 | +0.5 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| kicad-issue184-motorizedopener--motorizedopener | loss (cpu_s) | 0 | 0 | 0.0 | +1.1 |
...
| kicad-issue283-unconnectedtracesunderpads--natural_tone_preamp | loss (cpu_s) | 0 | 0 | 0.0 | +1.3 |
| kicad-issue367-ultraflactyl--ultraflactyl | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| kicad-issue558-dev-board-autoroute-demo--dev-board | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| kicad-issue632-miniautopilot--mini auto pilot | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue742-tastexx-pcb--tastexx-pcb | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-1-Wire-Wing-pcb_1-Wire_Wing | loss (cpu_s) | 0 | 0 | 0.0 | +0.3 |
| pcbench-12v-automatic-ups_ups-12v | loss (cpu_s) | 0 | 0 | 0.0 | +0.6 |
| pcbench-16x12-bits-I2C_I2C_Servo | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| pcbench-1Bitsy_1bitsy | loss (cpu_s) | 0 | 0 | 0.0 | +0.5 |
| … | and 715 more | | | | |

</details>

Baseline first: main `7d33cef+local-hole+main` · holes `7d33cef+local-hole+holes`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-local-hole-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-local-hole-full` from `reports/quality-epyc-local-hole-full.json`.</sub>
