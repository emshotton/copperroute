## Benchmark: mask-effective vs main

**worse** — the regression gate **fails**:

- mask-effective: 7 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 404 / 341 / 6 |
| Quality losses | 7 |
...
|---|---|---|---|---|---|
| pcbench-karabas-nano_karabas-nano-revG | loss (unrouted) | +12 | 0 | -58.3 | +0.4 |
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +3 | 0 | -19.2 | +0.1 |
| pcbench-kitspace_T32_ref | loss (score) | 0 | 0 | -0.0 | 0.0 |
| pcbench-kitspace_dropbot-front-panel | loss (score) | 0 | 0 | -0.0 | -0.0 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (score) | 0 | 0 | -0.0 | +0.2 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue283-unconnectedtracesunderpads--natural_tone_preamp | loss (cpu_s) | 0 | 0 | 0.0 | +24.7 |
| kicad-issue368-corneyislandwireless--corney_island_wireless | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-1-Wire-Wing-pcb_1-Wire_Wing | loss (cpu_s) | 0 | 0 | 0.0 | +0.8 |
| pcbench-12v-automatic-ups_ups-12v | loss (cpu_s) | 0 | 0 | 0.0 | +0.8 |
| pcbench-2d_conduction_sk9822-matrix | loss (cpu_s) | 0 | 0 | 0.0 | +0.7 |
| pcbench-4N35-TTL-Serial-Optoisolator_4N35-TTL-Serial-Optoisolator | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-6volt-5W-solar-cc_6vleadacidsolar | loss (cpu_s) | 0 | 0 | 0.0 | +6.3 |
| pcbench-74Logic_SA_ADC_SA-ADC | loss (cpu_s) | 0 | 0 | 0.0 | +17.3 |
| pcbench-96boards-sensors_Sensors | loss (cpu_s) | 0 | 0 | 0.0 | +7.4 |
| pcbench-AIOsense_AIOsense | loss (cpu_s) | 0 | 0 | 0.0 | +11.8 |
| pcbench-APC_AtariPunkConsole | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-AS5043-Encoder_sensor-board | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-AVR-ISP_level-shifter_AVR-ISP_level-shifter | loss (cpu_s) | 0 | 0 | 0.0 | +0.7 |
| pcbench-AVR-ISP_pogo-plug_1.27mm_AVR-ISP_pogo-plug_1.27mm | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| … | and 725 more | | | | |

</details>

Baseline first: main `7ecbeac2` · mask-effective `mask-effective-v1`

threads=1 jobs=12 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs mask-layers-full-01, mask-effective-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare mask-effective-full-01` from `reports/mask-effective-full-01.json`.</sub>
