## Benchmark: mask-both vs main

**worse** — the regression gate **fails**:

- mask-both: 54 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 18 / 726 / 7 |
| Quality losses | 54 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.74 → 0.74 |
| Median Δscore | 0.0 |
| Median time ratio | 1.08 |

<details><summary>744 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-m2-electronics_m2fc | loss (unrouted) | +103 | -7 | -481.5 | -102.3 |
| pcbench-Librecalc-Hardware__autosave-calculator | loss (unrouted) | +41 | +5 | -328.1 | -99.9 |
| pcbench-ReSDMAC_ReSDMAC | loss (unrouted) | +59 | 0 | -298.0 | -102.6 |
| pcbench-karabas-nano_karabas-nano-revA | loss (unrouted) | +41 | 0 | -277.0 | -94.2 |
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +39 | 0 | -250.0 | -99.3 |
| pcbench-nonSNES_SNSP-CPU-1CHIP | loss (unrouted) | +128 | 0 | -232.6 | -97.2 |
| pcbench-karabas-nano_karabas-nano-revG | loss (unrouted) | +38 | 0 | -184.5 | -89.3 |
| pcbench-kinetoscope_sram-bank | loss (unrouted) | +18 | +2 | -119.5 | -99.2 |
| pcbench-kitspace_dropbot-front-panel | loss (clean_pass_rate) | +17 | 0 | -118.9 | -104.8 |
| pcbench-pusheenz40_sadcatz40 | loss (unrouted) | +5 | +10 | -78.7 | -91.9 |
| pcbench-CoreOne-xCORE200-Original_CoreOne | loss (unrouted) | +19 | 0 | -77.6 | -92.4 |
| pcbench-karabas-nano_karabas-nano-revC | loss (unrouted) | +13 | 0 | -68.8 | -100.7 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (unrouted) | +14 | 0 | -62.2 | -100.2 |
| pcbench-BLDC-controller_BLDC_controller | loss (unrouted) | +4 | -2 | -56.2 | -17.0 |
| pcbench-amalthea_amalthea_rev0 | loss (unrouted) | +12 | 0 | -40.0 | -98.6 |
| pcbench-gb-hardware_GB-LIVE32 | loss (unrouted) | +3 | 0 | -35.3 | +14.9 |
| pcbench-kitspace_40-channel-hv-switching-board | loss (clean_pass_rate) | +6 | 0 | -29.0 | -101.2 |
| pcbench-azalea_azalea | loss (unrouted) | +5 | -7 | -26.7 | -101.1 |
| kicad-issue184-motorizedopener--motorizedopener | loss (unrouted) | +2 | 0 | -25.6 | +26.9 |
| pcbench-RoBoC_RoboticsMKII | loss (violations) | 0 | +12 | -22.6 | +13.4 |
| … | and 724 more | | | | |

</details>

Baseline first: main `7ecbeac2` · mask-both `mask-both-v1`

threads=1 jobs=12 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs mask-layers-full-01, mask-both-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare mask-both-full-01` from `reports/mask-both-full-01.json`.</sub>
