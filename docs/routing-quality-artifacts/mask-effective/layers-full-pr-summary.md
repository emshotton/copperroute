## Benchmark: mask-layers vs main

**worse** — the regression gate **fails**:

- mask-layers: 48 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 162 / 584 / 5 |
| Quality losses | 48 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.74 → 0.74 |
| Median Δscore | 0.0 |
| Median time ratio | 1.06 |

<details><summary>746 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-m2-electronics_m2fc | loss (unrouted) | +110 | -7 | -514.7 | -107.7 |
| pcbench-karabas-nano_karabas-nano-revA | loss (unrouted) | +55 | 0 | -371.6 | -102.9 |
| pcbench-ReSDMAC_ReSDMAC | loss (unrouted) | +59 | 0 | -298.0 | -109.3 |
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +46 | 0 | -294.9 | -106.0 |
| pcbench-nonSNES_SNSP-CPU-1CHIP | loss (unrouted) | +128 | 0 | -232.6 | -94.9 |
| pcbench-karabas-nano_karabas-nano-revG | loss (unrouted) | +35 | 0 | -169.9 | -97.3 |
| pcbench-kitspace_dropbot-front-panel | loss (clean_pass_rate) | +23 | 0 | -160.8 | -123.0 |
| pcbench-kinetoscope_sram-bank | loss (unrouted) | +17 | 0 | -110.4 | -104.1 |
| pcbench-zx-sizif-512-ext_sizif512ext | loss (unrouted) | +17 | 0 | -95.0 | -38.7 |
| pcbench-azalea_azalea | loss (unrouted) | +15 | -11 | -94.8 | -130.0 |
| pcbench-karabas-nano_karabas-nano-revC | loss (unrouted) | +16 | 0 | -84.7 | -104.8 |
| pcbench-pusheenz40_sadcatz40 | loss (unrouted) | +5 | +10 | -78.7 | -95.7 |
| pcbench-amalthea_amalthea_rev0 | loss (unrouted) | +17 | 0 | -56.7 | -121.6 |
| pcbench-bms-8s50-ic_bms-8s50-ic | loss (unrouted) | +8 | 0 | -55.9 | -119.3 |
| pcbench-wavegen_rev3 | loss (unrouted) | +4 | 0 | -53.3 | -55.1 |
| pcbench-kitspace_40-channel-hv-switching-board | loss (clean_pass_rate) | +9 | 0 | -43.5 | -105.5 |
| pcbench-zx-sizif-xxs_sizif-xxs | loss (unrouted) | +5 | 0 | -40.7 | -26.8 |
| pcbench-gb-hardware_GB-LIVE32 | loss (unrouted) | +3 | 0 | -35.3 | +10.1 |
| pcbench-RoBoC_RoboticsMKII | loss (violations) | 0 | +12 | -22.6 | -10.8 |
| pcbench-real-time-chess_kfchess | loss (unrouted) | +1 | +12 | -15.1 | -91.6 |
| … | and 726 more | | | | |

</details>

Baseline first: main `7ecbeac2` · mask-layers `mask-layers-v1`

threads=1 jobs=12 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs mask-layers-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare mask-layers-full-01` from `reports/mask-layers-full-01.json`.</sub>
