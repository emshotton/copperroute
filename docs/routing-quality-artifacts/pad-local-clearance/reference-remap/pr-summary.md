## Benchmark: remapped vs main

**worse** — the regression gate **fails**:

- remapped: 19 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 340 / 360 / 51 |
| Quality losses | 19 |
...
<details><summary>700 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-Hardware_Playground_minimal_node_rfm69w | loss (unrouted) | +2 | -2 | -53.3 | -1.6 |
| pcbench-azalea_azalea | loss (unrouted) | +4 | -45 | +37.0 | -27.8 |
| pcbench-bms-8s50-ic_bms-8s50-ic | loss (unrouted) | +2 | 0 | -14.0 | +1.2 |
| pcbench-mppt-2420-hpx_mppt-2420-hpx | loss (unrouted) | +2 | 0 | -12.8 | +53.1 |
| pcbench-oled-bmp280-touch_oled-bmp280-touch | loss (clean_pass_rate) | 0 | +2 | -12.1 | -0.0 |
| pcbench-Brushless_ESC_Brushless_ESC | loss (clean_pass_rate) | 0 | +1 | -4.0 | -3.0 |
| pcbench-BLDC-controller_BLDC_controller | loss (violations) | 0 | +1 | -3.1 | +41.1 |
| pcbench-mavbridge_mavbridge | loss (score) | 0 | 0 | -0.0 | -9.4 |
| pcbench-pwm-2420-lus_pwm-2420-lus | loss (score) | 0 | 0 | -0.0 | -24.6 |
| pcbench-DAC-ADAU1966_DAC-ADAU1966 | loss (score) | 0 | 0 | -0.0 | -16.8 |
| pcbench-rfcx-sentinel-pcb_Mainboard | loss (score) | 0 | 0 | -0.0 | -32.4 |
| pcbench-kitspace_esp8266 | loss (score) | 0 | 0 | -0.0 | +2.3 |
| pcbench-SNAP-Badge_SNAP_badge | loss (score) | 0 | 0 | -0.0 | -34.8 |
| pcbench-R1002_R1002 | loss (score) | 0 | 0 | -0.0 | +0.6 |
| pcbench-mppt-2420-hc_mppt-2420-hc | loss (score) | 0 | 0 | -0.0 | -21.4 |
| pcbench-SMDBreakouts_smd_breakout | loss (score) | 0 | 0 | -0.0 | +0.3 |
| pcbench-SMDBreakouts_smd_breakout_quad | loss (score) | 0 | 0 | -0.0 | +0.4 |
| pcbench-ssr-wifi_adapter | loss (score) | 0 | 0 | -0.0 | +0.2 |
| pcbench-AS5043-Encoder_sensor-board | loss (score) | 0 | 0 | -0.0 | -0.1 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.4 |
| … | and 680 more | | | | |

</details>

Baseline first: main `d84ac9e+main+reference-remap` · remapped `d84ac9e+remapped+reference-remap`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-reference-remap-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-reference-remap-full` from `reports/quality-epyc-reference-remap-full.json`.</sub>
