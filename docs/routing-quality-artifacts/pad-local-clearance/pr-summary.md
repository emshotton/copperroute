## Benchmark: pad-copper vs main

**worse** — the regression gate **fails**:

- pad-copper: 268 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 447 / 302 / 2 |
| Quality losses | 268 |
...
| pcbench-gb-hardware_GB-CART256K-A | loss (unrouted) | +8 | -2 | -176.7 | -48.8 |
| pcbench-autohat-board_inverted-usd-adapter | loss (clean_pass_rate) | 0 | +7 | -175.0 | 0.0 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (unrouted) | +2 | +2 | -133.3 | -13.4 |
| pcbench-rs485-moist-sensor_rs485-moist-sensor | loss (unrouted) | +2 | 0 | -105.3 | -2.2 |
| pcbench-8bit-cpu_programming_interface | loss (unrouted) | +3 | 0 | -83.3 | +7.5 |
| pcbench-Solare-BQ24210_Solare-BQ24210 | loss (clean_pass_rate) | +1 | 0 | -83.3 | +67.0 |
| pcbench-rxadc_14_rxadc_14 | loss (clean_pass_rate) | +4 | 0 | -78.4 | +41.1 |
| pcbench-EnvOpenPico_EliteMicro2040 | loss (unrouted) | +4 | 0 | -70.2 | +33.5 |
| pcbench-CATs-Eurosynth_HAGIWO_MultiOut_Main | loss (unrouted) | +2 | 0 | -54.1 | +2.5 |
| pcbench-CATs-Eurosynth_Buffered_Multiple_Main | loss (clean_pass_rate) | +1 | 0 | -52.6 | +0.1 |
| pcbench-LittleArduinoProjects_LEDx16_board | loss (unrouted) | +2 | 0 | -51.3 | -3.6 |
| pcbench-CATs-Eurosynth_Abakus_Main | loss (unrouted) | +3 | 0 | -50.0 | +6.2 |
| pcbench-gb-hardware_GB-CARTPP-XC | loss (unrouted) | +2 | 0 | -44.4 | -24.8 |
| pcbench-TLPHnodeV2_TLPHnodeV2 | loss (clean_pass_rate) | +1 | 0 | -43.5 | +52.1 |
| pcbench-epaper-102_epaper-102 | loss (violations) | 0 | +6 | -41.4 | +1.4 |
...
| pcbench-nfl-led-scoreboard_passive3-rpi-hub75-adapter | loss (unrouted) | +1 | 0 | -37.0 | -16.5 |
| pcbench-snappi-zero_snappi-zero | loss (violations) | 0 | +2 | -36.4 | -0.1 |
| … | and 729 more | | | | |

</details>

Baseline first: main `e9d10c21da58653fb5332df44021f25180a3d4da` · pad-copper `c461555+pad-copper+new-metadata`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-pad-copper-matched-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-pad-copper-matched-vs-main` from `reports/quality-epyc-pad-copper-matched-vs-main.json`.</sub>
