...
- pad-copper: 13 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 352 / 345 / 54 |
| Quality losses | 13 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.73 → 0.74 |
| Median Δscore | 0.0 |
| Median time ratio | 1.00 |

<details><summary>697 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-Hardware_Playground_minimal_node_rfm69w | loss (unrouted) | +2 | -2 | -53.3 | -2.9 |
| pcbench-azalea_azalea | loss (unrouted) | +4 | -45 | +37.0 | -33.3 |
| pcbench-mppt-2420-hpx_mppt-2420-hpx | loss (unrouted) | +2 | 0 | -12.8 | +54.1 |
| pcbench-oled-bmp280-touch_oled-bmp280-touch | loss (clean_pass_rate) | 0 | +2 | -12.1 | 0.0 |
| pcbench-Brushless_ESC_Brushless_ESC | loss (clean_pass_rate) | 0 | +1 | -4.0 | -2.7 |
| pcbench-BLDC-controller_BLDC_controller | loss (violations) | 0 | +1 | -3.1 | +43.7 |
| pcbench-pwm-2420-lus_pwm-2420-lus | loss (score) | 0 | 0 | -0.0 | -34.0 |
| pcbench-SNAP-Badge_SNAP_badge | loss (score) | 0 | 0 | -0.0 | -9.3 |
| pcbench-DAC-ADAU1966_DAC-ADAU1966 | loss (score) | 0 | 0 | -0.0 | -27.9 |
| pcbench-rfcx-sentinel-pcb_Mainboard | loss (score) | 0 | 0 | -0.0 | -33.4 |
| pcbench-R1002_R1002 | loss (score) | 0 | 0 | -0.0 | +0.2 |
| pcbench-mppt-2420-hc_mppt-2420-hc | loss (score) | 0 | 0 | -0.0 | -6.7 |
| pcbench-m2-electronics_m2fc | loss (score) | 0 | 0 | -0.0 | -8.4 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.3 |
| kicad-issue184-motorizedopener--motorizedopener | loss (cpu_s) | 0 | 0 | 0.0 | +0.4 |
...
| kicad-issue283-unconnectedtracesunderpads--natural_tone_preamp | loss (cpu_s) | 0 | 0 | 0.0 | +0.6 |
| kicad-issue367-ultraflactyl--ultraflactyl | loss (cpu_s) | 0 | 0 | 0.0 | +0.8 |
| kicad-issue368-corneyislandwireless--corney_island_wireless | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| … | and 677 more | | | | |

</details>

Baseline first: main `d84ac9e84a52b5569b125cfb6f7444fbe8fdf4ce` · pad-copper `d84ac9e+pad-copper-new-metadata`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-pad-post-main-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-pad-post-main` from `reports/quality-epyc-pad-post-main.json`.</sub>
