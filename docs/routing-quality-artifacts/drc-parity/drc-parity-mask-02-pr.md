## Benchmark: drc vs main

**worse** — the regression gate **fails**:

- drc: 6 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 402 / 326 / 23 |
| Quality losses | 6 |
...
<details><summary>728 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +6 | 0 | -38.5 | -0.9 |
| pcbench-Librecalc-Hardware__autosave-calculator | loss (unrouted) | +2 | 0 | -15.6 | +0.1 |
| pcbench-RC6502-Apple-1-Replica_RC6502_VDU | loss (unrouted) | +1 | 0 | -11.5 | +0.5 |
| pcbench-ReSDMAC_ReSDMAC | loss (unrouted) | +1 | 0 | -5.1 | 0.0 |
| pcbench-96boards-sensors_Sensors | loss (score) | 0 | 0 | -0.0 | +0.4 |
| pcbench-kitspace_40-channel-hv-switching-board | loss (score) | 0 | 0 | -0.0 | 0.0 |
| kicad-issue269-min_fr_test--min_fr_test | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| kicad-issue558-dev-board-autoroute-demo--dev-board | loss (cpu_s) | 0 | 0 | 0.0 | +0.5 |
| pcbench-1-Wire-Wing-pcb_1-Wire_Wing | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-16x12-bits-I2C_I2C_Servo | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-1Bitsy_1bitsy | loss (cpu_s) | 0 | 0 | 0.0 | +1.3 |
| pcbench-655_testboard | loss (cpu_s) | 0 | 0 | 0.0 | +0.3 |
| pcbench-8bit-cpu_arduino_eeprom_programmer | loss (cpu_s) | 0 | 0 | 0.0 | +0.4 |
| pcbench-8bit-cpu_programming_interface | loss (cpu_s) | 0 | 0 | 0.0 | +0.5 |
| pcbench-APC_AtariPunkConsole | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| pcbench-ATtiny461Breakout_ATTiny461DevBoard | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-AVR-ISP_level-shifter_AVR-ISP_level-shifter | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-AVR-ISP_pogo-plug_1.27mm_AVR-ISP_pogo-plug_1.27mm | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-AnalogThermometer_AnalogThermometer | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| … | and 708 more | | | | |

</details>

Baseline first: main `736d02d+web-structural-main` · drc `736d02d+drc-mask-parity-v3`

threads=1 jobs=112 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs structural-full-01, drc-parity-mask-02.
...
<sub>Generated by `uv run bench pr-summary --compare drc-parity-mask-02` from `reports/drc-parity-mask-02.json`.</sub>
