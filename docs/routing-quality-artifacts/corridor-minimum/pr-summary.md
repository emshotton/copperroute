## Benchmark: corridor-minimum vs main

**worse** — the regression gate **fails**:

- corridor-minimum: 262 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 452 / 297 / 2 |
| Quality losses | 262 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.65 → 0.74 |
| Median Δscore | 0.0 |
| Median time ratio | 0.90 |

<details><summary>749 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-avr-fuser-32_adapter | loss (violations) | 0 | +25 | -250.0 | +204.8 |
| pcbench-autohat-board_inverted-usd-adapter | loss (clean_pass_rate) | 0 | +7 | -175.0 | 0.0 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (unrouted) | +2 | +3 | -144.4 | -11.7 |
| pcbench-gb-hardware_GB-CART256K-A | loss (unrouted) | +6 | -1 | -134.9 | -27.2 |
| pcbench-Solare-BQ24210_Solare-BQ24210 | loss (clean_pass_rate) | +1 | 0 | -83.3 | +67.3 |
| pcbench-Hardware_Playground_rpi_zero | loss (violations) | 0 | +13 | -59.1 | -15.0 |
| pcbench-kitspace_dropbot-front-panel | loss (unrouted) | +8 | 0 | -55.9 | +1.9 |
| pcbench-CATs-Eurosynth_HAGIWO_MultiOut_Main | loss (unrouted) | +2 | 0 | -54.1 | +2.4 |
| pcbench-CATs-Eurosynth_Buffered_Multiple_Main | loss (clean_pass_rate) | +1 | 0 | -52.6 | 0.0 |
| pcbench-EnvOpenPico_EliteMicro2040 | loss (unrouted) | +3 | 0 | -52.6 | +19.5 |
| pcbench-LittleArduinoProjects_LEDx16_board | loss (unrouted) | +2 | 0 | -51.3 | -3.5 |
| pcbench-TLPHnodeV2_TLPHnodeV2 | loss (clean_pass_rate) | +1 | 0 | -43.5 | +53.1 |
| pcbench-CATs-Eurosynth_Arduino_VCO_Main | loss (unrouted) | +1 | 0 | -40.0 | -4.6 |
| pcbench-nfl-led-scoreboard_passive3-rpi-hub75-adapter | loss (unrouted) | +1 | 0 | -37.0 | -22.3 |
| pcbench-gb-hardware_GB-CART32K-A | loss (clean_pass_rate) | +1 | 0 | -35.7 | -29.7 |
| pcbench-RC6502-Apple-1-Replica_RC6502_VDU | loss (unrouted) | +3 | 0 | -34.5 | +14.1 |
| pcbench-8bit-cpu_programming_interface | loss (unrouted) | +1 | 0 | -27.8 | +32.6 |
| pcbench-dorkyboard_keyboard | loss (clean_pass_rate) | +4 | 0 | -27.4 | +58.2 |
| pcbench-hbr-mk2_hbr-mk2-digital | loss (unrouted) | +2 | 0 | -26.0 | -16.9 |
| pcbench-pico-pi-rel_pico-pi | loss (unrouted) | +3 | 0 | -24.6 | -1.0 |
| … | and 729 more | | | | |

</details>

Baseline first: main `e9d10c21da58653fb5332df44021f25180a3d4da` · corridor-minimum `aa92bf1+corridor-enabled`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-corridor-minimum-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-corridor-minimum-vs-main` from `reports/quality-epyc-corridor-minimum-vs-main.json`.</sub>
