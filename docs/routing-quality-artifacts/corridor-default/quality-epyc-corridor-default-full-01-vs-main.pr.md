## Benchmark: default vs main

**worse** — the regression gate **fails**:

- default: 116 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 238 / 491 / 22 |
| Quality losses | 116 |
...
<details><summary>729 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-boatcontrol_NonLatchingNO30A | loss (unrouted) | +6 | 0 | -122.5 | -64.3 |
| pcbench-uSKY_uSKY | loss (unrouted) | +3 | 0 | -81.1 | -0.4 |
| pcbench-cnlohr_wiflier_B | loss (unrouted) | +3 | 0 | -75.0 | +2.3 |
| pcbench-kitspace_dropbot-front-panel | loss (unrouted) | +9 | 0 | -62.9 | +0.2 |
| pcbench-karabas-nano_karabas-nano-revC | loss (unrouted) | +9 | 0 | -47.6 | +0.1 |
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +7 | 0 | -44.9 | -0.6 |
| kicad-issue184-motorizedopener--motorizedopener | loss (unrouted) | +3 | +1 | -41.0 | +13.2 |
| pcbench-epaper-102_epaper-102 | loss (unrouted) | +1 | 0 | -34.5 | +0.8 |
| pcbench-TB6600StepperDriver_DEW_TB6600-V1 | loss (unrouted) | +2 | 0 | -34.5 | -12.0 |
| pcbench-azalea_azalea | loss (unrouted) | +4 | 0 | -29.6 | +15.7 |
| pcbench-OpenHardwareExG_Shield_OpenHardwareExG_Shield | loss (unrouted) | +2 | +4 | -20.0 | +32.4 |
| pcbench-m2-electronics_m2fc | loss (unrouted) | +4 | -3 | -16.1 | -0.1 |
| pcbench-GameTiger_GameTiger | loss (unrouted) | +1 | 0 | -13.5 | -11.0 |
| pcbench-rp2040-dmxsun_baseboard_2slots | loss (violations) | 0 | +3 | -12.5 | +8.5 |
| pcbench-Teensy-3.5-Breakout-Boaard_TeensyMegaIoShield | loss (unrouted) | +1 | 0 | -11.9 | -9.6 |
| pcbench-pwm-2420-lus_pwm-2420-lus | loss (unrouted) | +1 | 0 | -11.5 | -6.8 |
| pcbench-zx-sizif-512-ext_sizif512ext | loss (unrouted) | +2 | 0 | -11.2 | -0.1 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (violations) | 0 | +1 | -11.1 | +1.6 |
| pcbench-gb-hardware_GB-MBCTEST | loss (unrouted) | +1 | 0 | -10.8 | -4.4 |
| pcbench-BLDC-controller_BLDC_controller | loss (unrouted) | +1 | -2 | -9.4 | -17.2 |
| … | and 709 more | | | | |

</details>

Baseline first: main `f9d4be5+main` · default `f9d4be5+default`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-corridor-default-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-corridor-default-full-01-vs-main` from `reports/quality-epyc-corridor-default-full-01-vs-main.json`.</sub>
