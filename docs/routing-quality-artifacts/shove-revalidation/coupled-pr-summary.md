coupled vs main: worse (257W/473L/21T)
coupled: compared 751/751 shared boards; 0 incomplete, 0 skipped
reports written to /root/copperroute-bench/benchmark/reports/quality-epyc-shove-coupled-full.{json,md,pr.md,html}
paste into a pull request: uv run bench pr-summary --compare quality-epyc-shove-coupled-full
regression check failed; see the comparison report:
  coupled: 112 routing-quality losses
---GENERATED_PR_SUMMARY---
## Benchmark: coupled vs main
...
<details><summary>730 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-boatcontrol_NonLatchingNO30A | loss (unrouted) | +6 | 0 | -122.5 | -65.4 |
| pcbench-uSKY_uSKY | loss (unrouted) | +3 | 0 | -81.1 | -0.7 |
| pcbench-cnlohr_wiflier_B | loss (unrouted) | +3 | 0 | -75.0 | -2.5 |
| kicad-issue184-motorizedopener--motorizedopener | loss (unrouted) | +3 | +1 | -41.0 | +12.1 |
| pcbench-epaper-102_epaper-102 | loss (unrouted) | +1 | 0 | -34.5 | +2.2 |
| pcbench-TB6600StepperDriver_DEW_TB6600-V1 | loss (unrouted) | +2 | 0 | -34.5 | -11.0 |
| pcbench-azalea_azalea | loss (unrouted) | +4 | 0 | -29.6 | -20.1 |
| pcbench-OpenHardwareExG_Shield_OpenHardwareExG_Shield | loss (unrouted) | +2 | +4 | -20.0 | +18.3 |
| pcbench-kitspace_dropbot-front-panel | loss (unrouted) | +2 | 0 | -14.0 | +1.9 |
| pcbench-GameTiger_GameTiger | loss (unrouted) | +1 | 0 | -13.5 | -10.8 |
| pcbench-rp2040-dmxsun_baseboard_2slots | loss (violations) | 0 | +3 | -12.5 | +8.3 |
| pcbench-BLDC-controller_BLDC_controller | loss (unrouted) | +1 | -1 | -12.5 | -33.3 |
| pcbench-Teensy-3.5-Breakout-Boaard_TeensyMegaIoShield | loss (unrouted) | +1 | 0 | -11.9 | -11.9 |
| pcbench-pwm-2420-lus_pwm-2420-lus | loss (unrouted) | +1 | 0 | -11.5 | -31.4 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (violations) | 0 | +1 | -11.1 | +1.5 |
| pcbench-gb-hardware_GB-MBCTEST | loss (unrouted) | +1 | 0 | -10.8 | -38.3 |
| pcbench-ESP07-Breakout_ESP07-Breakout | loss (violations) | 0 | +1 | -8.7 | -1.2 |
| pcbench-Own-Mailbox-Hardware_eth | loss (clean_pass_rate) | +1 | 0 | -6.4 | +29.6 |
| pcbench-Patternflow_patternflow | loss (violations) | 0 | +1 | -4.9 | -1.8 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (clean_pass_rate) | +1 | 0 | -4.4 | -0.2 |
| … | and 710 more | | | | |

</details>

Baseline first: main `54d4e80+main` · coupled `54d4e80+coupled`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-shove-coupled-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-shove-coupled-full` from `reports/quality-epyc-shove-coupled-full.json`.</sub>
