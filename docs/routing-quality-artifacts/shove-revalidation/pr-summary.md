guard vs main: worse (210W/521L/20T)
corridor vs main: worse (210W/521L/20T)
corridor-guard vs main: worse (244W/492L/15T)
guard: compared 751/751 shared boards; 0 incomplete, 0 skipped
corridor: compared 751/751 shared boards; 0 incomplete, 0 skipped
corridor-guard: compared 751/751 shared boards; 0 incomplete, 0 skipped
reports written to /root/copperroute-bench/benchmark/reports/quality-epyc-shove-revalidation-full.{json,md,pr.md,html}
paste into a pull request: uv run bench pr-summary --compare quality-epyc-shove-revalidation-full
regression check failed; see the comparison report:
  guard: 6 routing-quality losses
  corridor: 112 routing-quality losses
  corridor-guard: 112 routing-quality losses
---GENERATED_PR_SUMMARY---
## Benchmark: guard, corridor, corridor-guard vs main

**worse**, **worse**, **worse** — the regression gate **fails**:
...
| Wins / losses / ties | 210 / 521 / 20 |
| Quality losses | 6 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.75 → 0.75 |
| Median Δscore | 0.0 |
| Median time ratio | 1.01 |

<details><summary>731 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-boatcontrol_NonLatchingNO30A | loss (unrouted) | +6 | 0 | -122.5 | -61.9 |
| pcbench-uSKY_uSKY | loss (unrouted) | +3 | 0 | -81.1 | -1.5 |
| pcbench-EncoderBoard_Enc_Pan_Led | loss (score) | 0 | 0 | -0.0 | -0.7 |
| pcbench-zx-sizif-512-ext_sizif512ext | loss (score) | 0 | 0 | -0.0 | -0.3 |
| pcbench-digital_clock_led_clock_v1 | loss (score) | 0 | 0 | -0.0 | -6.0 |
| pcbench-m2-electronics_m2fc | loss (score) | 0 | 0 | -0.0 | -0.3 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.4 |
| kicad-issue184-motorizedopener--motorizedopener | loss (cpu_s) | 0 | 0 | 0.0 | +1.4 |
| kicad-issue269-min_fr_test--min_fr_test | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| kicad-issue269-noviasonpowerplanes--issue269-noviasonpowerplanes | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (cpu_s) | 0 | 0 | 0.0 | +0.3 |
| kicad-issue283-unconnectedtracesunderpads--natural_tone_preamp | loss (cpu_s) | 0 | 0 | 0.0 | +0.8 |
| kicad-issue367-ultraflactyl--ultraflactyl | loss (cpu_s) | 0 | 0 | 0.0 | +0.9 |
| kicad-issue368-corneyislandwireless--corney_island_wireless | loss (peak_rss_mb) | 0 | 0 | 0.0 | 0.0 |
| kicad-issue558-dev-board-autoroute-demo--dev-board | loss (cpu_s) | 0 | 0 | 0.0 | +0.6 |
| kicad-issue632-miniautopilot--mini auto pilot | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| kicad-issue742-tastexx-pcb--tastexx-pcb | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| pcbench-1-Wire-Wing-pcb_1-Wire_Wing | loss (cpu_s) | 0 | 0 | 0.0 | +0.2 |
| pcbench-12v-automatic-ups_ups-12v | loss (cpu_s) | 0 | 0 | 0.0 | +0.6 |
| pcbench-16x12-bits-I2C_I2C_Servo | loss (cpu_s) | 0 | 0 | 0.0 | +0.4 |
| … | and 711 more | | | | |
...
| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-cnlohr_wiflier_B | loss (unrouted) | +3 | 0 | -75.0 | +1.9 |
| pcbench-kitspace_dropbot-front-panel | loss (unrouted) | +10 | 0 | -69.9 | -0.2 |
| pcbench-karabas-nano_karabas-nano-revC | loss (unrouted) | +12 | 0 | -63.5 | -1.0 |
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +9 | 0 | -57.7 | -0.6 |
| pcbench-OpenHardwareExG_Shield_OpenHardwareExG_Shield | loss (unrouted) | +2 | +24 | -48.6 | +31.4 |
| kicad-issue184-motorizedopener--motorizedopener | loss (unrouted) | +3 | +1 | -41.0 | +11.9 |
| pcbench-epaper-102_epaper-102 | loss (unrouted) | +1 | 0 | -34.5 | +2.6 |
| pcbench-TB6600StepperDriver_DEW_TB6600-V1 | loss (unrouted) | +2 | 0 | -34.5 | -11.8 |
| pcbench-azalea_azalea | loss (unrouted) | +4 | 0 | -29.6 | +14.2 |
| pcbench-m2-electronics_m2fc | loss (unrouted) | +4 | -3 | -16.1 | -0.2 |
| pcbench-GameTiger_GameTiger | loss (unrouted) | +1 | 0 | -13.5 | -11.4 |
| pcbench-rp2040-dmxsun_baseboard_2slots | loss (violations) | 0 | +3 | -12.5 | +8.6 |
| pcbench-Teensy-3.5-Breakout-Boaard_TeensyMegaIoShield | loss (unrouted) | +1 | 0 | -11.9 | -9.0 |
| pcbench-pwm-2420-lus_pwm-2420-lus | loss (unrouted) | +1 | 0 | -11.5 | -8.2 |
| pcbench-zx-sizif-512-ext_sizif512ext | loss (unrouted) | +2 | 0 | -11.2 | -0.0 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (violations) | 0 | +1 | -11.1 | +1.5 |
| pcbench-gb-hardware_GB-MBCTEST | loss (unrouted) | +1 | 0 | -10.8 | -1.2 |
| pcbench-BLDC-controller_BLDC_controller | loss (unrouted) | +1 | -2 | -9.4 | -17.7 |
| pcbench-ESP07-Breakout_ESP07-Breakout | loss (violations) | 0 | +1 | -8.7 | -0.8 |
| pcbench-Own-Mailbox-Hardware_eth | loss (clean_pass_rate) | +1 | 0 | -6.4 | +61.3 |
| … | and 711 more | | | | |
...
<details><summary>736 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-boatcontrol_NonLatchingNO30A | loss (unrouted) | +6 | 0 | -122.5 | -61.5 |
| pcbench-uSKY_uSKY | loss (unrouted) | +3 | 0 | -81.1 | -1.5 |
| pcbench-cnlohr_wiflier_B | loss (unrouted) | +3 | 0 | -75.0 | +0.7 |
| kicad-issue184-motorizedopener--motorizedopener | loss (unrouted) | +3 | +1 | -41.0 | +13.8 |
| pcbench-epaper-102_epaper-102 | loss (unrouted) | +1 | 0 | -34.5 | +2.8 |
| pcbench-TB6600StepperDriver_DEW_TB6600-V1 | loss (unrouted) | +2 | 0 | -34.5 | -14.0 |
| pcbench-azalea_azalea | loss (unrouted) | +4 | 0 | -29.6 | -36.3 |
| pcbench-kitspace_dropbot-front-panel | loss (unrouted) | +3 | 0 | -21.0 | +1.8 |
| pcbench-OpenHardwareExG_Shield_OpenHardwareExG_Shield | loss (unrouted) | +2 | +4 | -20.0 | +15.7 |
| pcbench-GameTiger_GameTiger | loss (unrouted) | +1 | 0 | -13.5 | -11.5 |
| pcbench-rp2040-dmxsun_baseboard_2slots | loss (violations) | 0 | +3 | -12.5 | +8.5 |
| pcbench-Teensy-3.5-Breakout-Boaard_TeensyMegaIoShield | loss (unrouted) | +1 | 0 | -11.9 | -16.7 |
| pcbench-pwm-2420-lus_pwm-2420-lus | loss (unrouted) | +1 | 0 | -11.5 | -36.7 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (violations) | 0 | +1 | -11.1 | +1.5 |
| pcbench-gb-hardware_GB-MBCTEST | loss (unrouted) | +1 | 0 | -10.8 | -30.4 |
| pcbench-BLDC-controller_BLDC_controller | loss (unrouted) | +1 | -2 | -9.4 | -33.1 |
| pcbench-ESP07-Breakout_ESP07-Breakout | loss (violations) | 0 | +1 | -8.7 | -0.7 |
| pcbench-Own-Mailbox-Hardware_eth | loss (clean_pass_rate) | +1 | 0 | -6.4 | +25.9 |
| pcbench-Patternflow_patternflow | loss (violations) | 0 | +1 | -4.9 | -1.7 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (clean_pass_rate) | +1 | 0 | -4.4 | +0.9 |
| … | and 716 more | | | | |

</details>

Baseline first: main `54d4e80+main` · guard `54d4e80+guard` · corridor `54d4e80+corridor` · corridor-guard `54d4e80+corridor-guard`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-shove-revalidation-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-shove-revalidation-full` from `reports/quality-epyc-shove-revalidation-full.json`.</sub>
