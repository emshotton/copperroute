## Benchmark: corridor-coherent vs main

**worse** — the regression gate **fails**:

- corridor-coherent: 264 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 449 / 300 / 2 |
| Quality losses | 264 |
| Performance losses | 0 (advisory) |
| Clean-pass rate | 0.65 → 0.74 |
| Median Δscore | 0.0 |
| Median time ratio | 0.91 |

<details><summary>749 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-avr-fuser-32_adapter | loss (violations) | 0 | +25 | -250.0 | +205.8 |
| pcbench-autohat-board_inverted-usd-adapter | loss (clean_pass_rate) | 0 | +7 | -175.0 | 0.0 |
| pcbench-snappi-zero_snappi-zero | loss (violations) | 0 | +9 | -163.6 | -0.3 |
| pcbench-pmw3360-pcb_pmw3360_pcb_jst | loss (unrouted) | +2 | +3 | -144.4 | -11.9 |
| pcbench-gb-hardware_GB-CART256K-A | loss (unrouted) | +6 | -1 | -134.9 | -15.8 |
| pcbench-Solare-BQ24210_Solare-BQ24210 | loss (clean_pass_rate) | +1 | 0 | -83.3 | +66.6 |
| pcbench-Hardware_Playground_rpi_zero | loss (violations) | 0 | +13 | -59.1 | -14.6 |
| pcbench-kitspace_dropbot-front-panel | loss (unrouted) | +8 | 0 | -55.9 | +2.1 |
...
| pcbench-EnvOpenPico_EliteMicro2040 | loss (unrouted) | +3 | 0 | -52.6 | +19.8 |
...
| pcbench-CATs-Eurosynth_Arduino_VCO_Main | loss (unrouted) | +1 | 0 | -40.0 | -4.9 |
| pcbench-CATs-Eurosynth_LFO_Main | loss (unrouted) | +1 | +1 | -38.7 | -0.7 |
| pcbench-nfl-led-scoreboard_passive3-rpi-hub75-adapter | loss (unrouted) | +1 | 0 | -37.0 | -23.1 |
| pcbench-gb-hardware_GB-CART32K-A | loss (clean_pass_rate) | +1 | 0 | -35.7 | -30.1 |
| pcbench-RC6502-Apple-1-Replica_RC6502_VDU | loss (unrouted) | +3 | 0 | -34.5 | +18.9 |
| pcbench-8bit-cpu_programming_interface | loss (unrouted) | +1 | 0 | -27.8 | +31.8 |
| pcbench-dorkyboard_keyboard | loss (clean_pass_rate) | +4 | 0 | -27.4 | +49.3 |
| … | and 729 more | | | | |

</details>

Baseline first: main `e9d10c21da58653fb5332df44021f25180a3d4da` · corridor-coherent `c461555+corridor-coherent`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-corridor-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-corridor-vs-main` from `reports/quality-epyc-corridor-vs-main.json`.</sub>
