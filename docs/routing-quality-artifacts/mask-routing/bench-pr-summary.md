## Benchmark: mask-review vs main

**worse** — the regression gate **fails**:

- mask-review: 268 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 447 / 298 / 6 |
| Quality losses | 268 |
...
<details><summary>745 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-avr-fuser-32_adapter | loss (violations) | 0 | +25 | -250.0 | +205.4 |
| pcbench-gb-hardware_GB-CART256K-A | loss (unrouted) | +8 | -2 | -176.7 | -40.9 |
...
| pcbench-rs485-moist-sensor_rs485-moist-sensor | loss (unrouted) | +2 | 0 | -105.3 | -2.1 |
| pcbench-8bit-cpu_programming_interface | loss (unrouted) | +3 | 0 | -83.3 | +8.1 |
| pcbench-Solare-BQ24210_Solare-BQ24210 | loss (clean_pass_rate) | +1 | 0 | -83.3 | +67.8 |
| pcbench-rxadc_14_rxadc_14 | loss (clean_pass_rate) | +4 | 0 | -78.4 | +39.4 |
| pcbench-EnvOpenPico_EliteMicro2040 | loss (unrouted) | +4 | 0 | -70.2 | +35.2 |
| pcbench-Hardware_Playground_rpi_zero | loss (violations) | 0 | +13 | -59.1 | -13.5 |
| pcbench-CATs-Eurosynth_HAGIWO_MultiOut_Main | loss (unrouted) | +2 | 0 | -54.1 | +2.3 |
| pcbench-CATs-Eurosynth_Buffered_Multiple_Main | loss (clean_pass_rate) | +1 | 0 | -52.6 | +0.2 |
| pcbench-LittleArduinoProjects_LEDx16_board | loss (unrouted) | +2 | 0 | -51.3 | -3.5 |
| pcbench-CATs-Eurosynth_Abakus_Main | loss (unrouted) | +3 | 0 | -50.0 | +5.7 |
| pcbench-gb-hardware_GB-CARTPP-XC | loss (unrouted) | +2 | 0 | -44.4 | -24.9 |
| pcbench-TLPHnodeV2_TLPHnodeV2 | loss (clean_pass_rate) | +1 | 0 | -43.5 | +52.9 |
...
| pcbench-CATs-Eurosynth_LFO_Main | loss (unrouted) | +1 | +1 | -38.7 | -0.4 |
| pcbench-nfl-led-scoreboard_passive3-rpi-hub75-adapter | loss (unrouted) | +1 | 0 | -37.0 | -18.3 |
| … | and 725 more | | | | |

</details>

Baseline first: main `e9d10c21da58653fb5332df44021f25180a3d4da` · mask-review `36283c2+nominal-mask-gap-via-review`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-mask-review-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-mask-review-vs-main` from `reports/quality-epyc-mask-review-vs-main.json`.</sub>
