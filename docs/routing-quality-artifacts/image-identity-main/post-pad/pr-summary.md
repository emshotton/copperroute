## Benchmark: combined vs pads

**worse** — the regression gate **fails**:

- combined: 17 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 449 / 249 / 53 |
| Quality losses | 17 |
...
<details><summary>698 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-Hardware_Playground_minimal_node_rfm69w | loss (unrouted) | +1 | 0 | -33.3 | +1.7 |
| pcbench-Pi1541io_Pi1541io | loss (unrouted) | +1 | 0 | -24.4 | +43.3 |
| pcbench-esp32-ethernet_esp32-ethernet | loss (unrouted) | +1 | +1 | -22.2 | +4.6 |
| pcbench-kitspace_teensy-fx | loss (unrouted) | +1 | 0 | -11.1 | -58.6 |
| pcbench-balena-rover-wide-hat_resin-rover | loss (violations) | 0 | +1 | -2.1 | -36.1 |
| pcbench-divergence_meter_dm_control | loss (score) | 0 | 0 | -0.0 | -42.7 |
| pcbench-TK44_TK44 | loss (score) | 0 | 0 | -0.0 | -33.6 |
| pcbench-magic-table_etch-a-sketch_cyclone | loss (score) | 0 | 0 | -0.0 | -1.3 |
| pcbench-pusheenz40_sadcatz40 | loss (score) | 0 | 0 | -0.0 | +2.4 |
| pcbench-kitspace_OtterScreen | loss (score) | 0 | 0 | -0.0 | +0.3 |
| pcbench-analog_esr_meter_esr_meter_rev_a | loss (score) | 0 | 0 | -0.0 | -0.2 |
| pcbench-m2-electronics_m2fc | loss (score) | 0 | 0 | -0.0 | -1.5 |
| pcbench-tinyFISH_tinyBRUSH | loss (score) | 0 | 0 | -0.0 | +0.3 |
| pcbench-BirdAttractor_BirdAttractor_RevA | loss (score) | 0 | 0 | -0.0 | -0.3 |
| pcbench-kitspace__autosave-nunchuk_breakout | loss (score) | 0 | 0 | -0.0 | 0.0 |
| pcbench-KosselHotendBoard_KosselHotendPCB | loss (score) | 0 | 0 | -0.0 | 0.0 |
| pcbench-beyblock20_beyblock20 | loss (score) | 0 | 0 | -0.0 | +0.7 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
...
Baseline first: pads `d84ac9e+image-pad-pilot+pads` · combined `d84ac9e+image-pad-pilot+combined`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-image-pad-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-image-pad-full` from `reports/quality-epyc-image-pad-full.json`.</sub>
