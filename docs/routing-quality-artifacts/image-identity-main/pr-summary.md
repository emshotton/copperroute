## Benchmark: images vs main

**worse** — the regression gate **fails**:

- images: 19 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 345 / 356 / 50 |
| Quality losses | 19 |
...
<details><summary>701 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-Pi1541io_Pi1541io | loss (unrouted) | +3 | 0 | -73.2 | +25.6 |
| pcbench-Hardware_Playground_serial_gw_ATMEGA328P | loss (unrouted) | +2 | 0 | -60.6 | -19.1 |
| pcbench-Hardware_Playground_minimal_node_rfm69w | loss (unrouted) | +2 | -2 | -53.3 | +2.3 |
| pcbench-esp32-ethernet_esp32-ethernet | loss (unrouted) | +1 | +1 | -22.2 | +12.0 |
| pcbench-kitspace_teensy-fx | loss (unrouted) | +1 | 0 | -11.1 | -57.6 |
| pcbench-bms-8s50-ic_bms-8s50-ic | loss (unrouted) | +1 | 0 | -7.0 | +0.5 |
| pcbench-balena-rover-wide-hat_resin-rover | loss (violations) | 0 | +1 | -2.1 | -35.0 |
| pcbench-divergence_meter_dm_control | loss (score) | 0 | 0 | -0.0 | -41.7 |
| pcbench-TK44_TK44 | loss (score) | 0 | 0 | -0.0 | -29.0 |
| pcbench-magic-table_etch-a-sketch_cyclone | loss (score) | 0 | 0 | -0.0 | -1.3 |
| pcbench-pusheenz40_sadcatz40 | loss (score) | 0 | 0 | -0.0 | +0.9 |
| pcbench-kitspace_OtterScreen | loss (score) | 0 | 0 | -0.0 | +0.1 |
| pcbench-analog_esr_meter_esr_meter_rev_a | loss (score) | 0 | 0 | -0.0 | -0.2 |
| pcbench-m2-electronics_m2fc | loss (score) | 0 | 0 | -0.0 | -6.1 |
| pcbench-tinyFISH_tinyBRUSH | loss (score) | 0 | 0 | -0.0 | +0.4 |
| pcbench-BirdAttractor_BirdAttractor_RevA | loss (score) | 0 | 0 | -0.0 | -0.1 |
...
| pcbench-beyblock20_beyblock20 | loss (score) | 0 | 0 | -0.0 | +1.0 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| … | and 681 more | | | | |

</details>

Baseline first: main `d84ac9e84a52b5569b125cfb6f7444fbe8fdf4ce` · images `d84ac9e+preserved-image-identity`

threads=1 jobs=192 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs quality-epyc-image-main-01.
...
<sub>Generated by `uv run bench pr-summary --compare quality-epyc-image-main` from `reports/quality-epyc-image-main.json`.</sub>
