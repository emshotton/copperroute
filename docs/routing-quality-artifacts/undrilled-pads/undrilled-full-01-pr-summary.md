## Benchmark: undrilled vs main

**worse** — the regression gate **fails**:

- undrilled: 7 routing-quality losses

| metric | result |
|---|---|
| Boards compared | 751 of 751 shared |
| Wins / losses / ties | 362 / 373 / 16 |
| Quality losses | 7 |
...
<details><summary>735 boards changed</summary>

| board | verdict | Δunrouted | Δviol | Δscore | Δcpu s |
|---|---|---|---|---|---|
| pcbench-real-time-chess_kfchess | loss (unrouted) | +7 | +4 | -34.7 | +0.5 |
| pcbench-RC6502-Apple-1-Replica_RC6502_VDU | loss (unrouted) | +1 | 0 | -11.5 | +2.0 |
| pcbench-kinetoscope_sram-bank | loss (unrouted) | +1 | 0 | -6.5 | +1.5 |
| pcbench-karabas-nano_karabas-nano-revB | loss (unrouted) | +1 | 0 | -6.4 | +2.6 |
| pcbench-nonSNES_SNSP-CPU-1CHIP | loss (unrouted) | +1 | 0 | -4.1 | +0.4 |
| pcbench-kitspace_40-channel-hv-switching-board | loss (score) | 0 | 0 | -0.0 | +0.9 |
| pcbench-Librecalc-Hardware__autosave-calculator | loss (score) | 0 | 0 | -0.0 | +1.4 |
| kicad-issue180-test--test | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue269-nowiresonpowerlayers--proba | loss (cpu_s) | 0 | 0 | 0.0 | +1.6 |
| kicad-issue283-unconnectedtracesunderpads--natural_tone_preamp | loss (cpu_s) | 0 | 0 | 0.0 | +1.0 |
| kicad-issue558-dev-board-autoroute-demo--dev-board | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| kicad-issue632-miniautopilot--mini auto pilot | loss (cpu_s) | 0 | 0 | 0.0 | +0.3 |
| kicad-issue742-tastexx-pcb--tastexx-pcb | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-12v-automatic-ups_ups-12v | loss (cpu_s) | 0 | 0 | 0.0 | +0.6 |
| pcbench-16x12-bits-I2C_I2C_Servo | loss (cpu_s) | 0 | 0 | 0.0 | +0.1 |
| pcbench-1Bitsy_1bitsy | loss (cpu_s) | 0 | 0 | 0.0 | +1.8 |
| pcbench-2d_conduction_sk9822-matrix | loss (cpu_s) | 0 | 0 | 0.0 | +1.0 |
| pcbench-4N35-TTL-Serial-Optoisolator_4N35-TTL-Serial-Optoisolator | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-6N137-TTL-Serial-Optoisolator_6N137-TTL-Serial-Optoisolator | loss (cpu_s) | 0 | 0 | 0.0 | 0.0 |
| pcbench-6volt-5W-solar-cc_6vleadacidsolar | loss (cpu_s) | 0 | 0 | 0.0 | +0.5 |
| … | and 715 more | | | | |

</details>

Baseline first: main `f91d849-main` · undrilled `undrill-v1`

threads=1 jobs=112 max_passes=10 timeout=300s seeds=1, deciding on cpu s. Runs pass-repair-main-01, undrilled-full-01.
...
<sub>Generated by `uv run bench pr-summary --compare undrilled-vs-main` from `reports/undrilled-vs-main.json`.</sub>
